!(function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e, i) {
      ...
      const _ =
        'string' ==
          typeof (null === (r = null == b ? void 0 : b.versions) || void 0 === r
            ? void 0
      ...
      if ('object' != typeof navigator || _)
        ...
        (f = navigator.userAgent),
          ...
          (d =
            (f.indexOf('Macintosh') >= 0 || f.indexOf('iPad') >= 0 || f.indexOf('iPhone') >= 0) &&
      ...
      const w = o,
        ...
        k = (function () {
          ...
          if ('function' == typeof g.postMessage && !g.importScripts) {
            ...
            return (n) => {
              const i = ++t;
              e.push({ id: i, callback: n }), g.postMessage({ vscodeSetImmediateId: i }, '*');
            };
          }
          if ('function' == typeof (null == b ? void 0 : b.nextTick)) return b.nextTick.bind(b);
  ...
  function (e, t, n) {
    ...
    class _ {
      constructor() {
        (this._store = new b()), c(this), u(this._store, this);
      }
      dispose() {
    ...
    class k {
      ...
      initialize(e, t, n, i) {
        ...
        const r = y(i, (e, t) => this._protocol.sendMessage(e, t));
    ...
    function I(e, t = 0, n = e.byteLength, i = 0) {
      ...
      _step() {
        ...
        for (let t = 0; t < 80; t++)
          t < 20
            ...
            (r = (R(o, 5) + n + h + i + e.getUint32(4 * t, !1)) & 4294967295),
            (h = l),
            (l = s),
            (s = R(a, 30)),
            (a = o),
    ...
    N._bigBlock32 = new DataView(new ArrayBuffer(320));
    class H {
      constructor(e) {
        this.source = e;
      }
    ...
    function z(e, t, n) {
      return new P(new H(e), new H(t)).ComputeDiff(n).changes;
    }
    class W {
      static Assert(e, t) {
    ...
    class P {
      constructor(e, t, n = null) {
        ...
        const [i, r, o] = P._getElements(e),
          [a, s, l] = P._getElements(t);
      ...
      static _getElements(e) {
        ...
        if (P._isStringArray(t)) {
          const e = new Int32Array(t.length);
          for (let n = 0, i = t.length; n < i; n++) e[n] = M(t[n], 0);
          return [t, e, !0];
        }
      ...
      ElementsAreStrictEqual(e, t) {
        ...
        return (
          P._getStrictElement(this._originalSequence, e) ===
          P._getStrictElement(this._modifiedSequence, t)
        );
      }
      ...
      _ComputeDiff(e, t, n, i, r) {
        ...
        return r && (a = this.PrettifyChanges(a)), { quitEarly: o[0], changes: a };
      }
      ComputeDiffRecursive(e, t, n, i, r) {
        ...
        if (e > t || n > i) {
          ...
          return (
            n <= i
              ? (W.Assert(e === t + 1, 'originalStart should only be one more than originalEnd'),
                (r = [new S(e, 0, n, i - n + 1)]))
              : e <= t
              ? (W.Assert(n === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
                (r = [new S(e, t - e + 1, n, 0)]))
              : (W.Assert(e === t + 1, 'originalStart should only be one more than originalEnd'),
                W.Assert(n === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
                (r = [])),
      ...
      WALKTRACE(e, t, n, i, r, o, a, s, l, h, c, d, u, p, m, f, g, b) {
        ...
        do {
          ...
          t === y || (t < T && l[t - 1] < l[t + 1])
            ...
            : ((p = (c = l[t - 1] + 1) - k - i),
              ...
              (k = t - 1 - e)),
            L >= 0 && ((e = (l = this.m_forwardHistory[L])[0]), (y = 1), (T = l.length - 1));
        } while (--L >= -1);
        if (((_ = w.getReverseChanges()), b[0])) {
          ...
          (w = new D()),
            ...
            (k = u[0] - f[0] - s),
            (x = 1073741824),
            (L = g ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2);
          do {
            const e = k + r;
            e === y || (e < T && h[e - 1] >= h[e + 1])
              ? ((p = (c = h[e + 1] - 1) - k - s),
              ...
              : ((p = (c = h[e - 1]) - k - s),
                ...
                (k = e - 1 - r)),
              L >= 0 && ((r = (h = this.m_reverseHistory[L])[0]), (y = 1), (T = h.length - 1));
          } while (--L >= -1);
          v = w.getChanges();
        }
        ...
        for (let T = 1; T <= p / 2 + 1; T++) {
          ...
          for (let e = h; e <= c; e += 2) {
            ...
            if (
              ((f[e] = s),
              s + l > p + k && ((p = s), (k = l)),
              !y && Math.abs(e - _) <= T - 1 && s >= g[e])
            )
              return (
                (r[0] = s),
                (o[0] = l),
                n <= g[e] && T <= 1448
                  ? this.WALKTRACE(b, h, c, v, _, d, u, w, f, g, s, t, r, l, i, o, y, a)
                  : null
              );
          }
          const x = (p - e + (k - n) - T) / 2;
          if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(p, x))
            return (
              (a[0] = !0),
              (r[0] = p),
              (o[0] = k),
          ...
          (d = this.ClipDiagonalBound(_ - T, T, _, m)),
            (u = this.ClipDiagonalBound(_ + T, T, _, m));
          for (let p = d; p <= u; p += 2) {
            (s = p === d || (p < u && g[p - 1] >= g[p + 1]) ? g[p + 1] - 1 : g[p - 1]),
              (l = s - (p - _) - w);
            const m = s;
            for (; s > e && l > n && this.ElementsAreEqual(s, l); ) s--, l--;
            if (((g[p] = s), y && Math.abs(p - b) <= T && s <= f[p]))
              return (
                (r[0] = s),
                (o[0] = l),
                m >= f[p] && T <= 1448
          ...
          if (T <= 1447) {
            ...
            (e[0] = b - h + 1),
              O.Copy2(f, h, e, 1, c - h + 1),
              this.m_forwardHistory.push(e),
              (e = new Int32Array(u - d + 2)),
              (e[0] = _ - d + 1),
              O.Copy2(g, d, e, 1, u - d + 1),
              this.m_reverseHistory.push(e);
          }
        }
        return this.WALKTRACE(b, h, c, v, _, d, u, w, f, g, s, t, r, l, i, o, y, a);
      }
      PrettifyChanges(e) {
        ...
        for (let t = e.length - 1; t >= 0; t--) {
          ...
          for (let e = 1; ; e++) {
            ...
            if (a && !this.ModifiedElementsAreEqual(h, h + n.modifiedLength)) break;
            const c =
              (t === i && h === r ? 5 : 0) +
      ...
      ConcatenateChanges(e, t) {
        ...
        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
          ...
          return (
            O.Copy(e, 0, i, 0, e.length - 1),
            (i[e.length - 1] = n[0]),
            O.Copy(t, 1, i, e.length, t.length - 1),
            i
          );
        }
        {
          const n = new Array(e.length + t.length);
          return O.Copy(e, 0, n, 0, e.length), O.Copy(t, 0, n, e.length, t.length), n;
        }
      }
          ...
          if (a === h - 1 || 1 === s);
            ...
            if (
              ...
              if (r.length > 2) {
                ...
                -1 === e
                  ? ((r = ''), (o = 0))
                  : ((r = r.slice(0, e)), (o = r.length - 1 - r.lastIndexOf(n))),
                  (a = h),
                  (s = 0);
                continue;
              }
            ...
            r.length > 0 ? (r += `${n}${e.slice(a + 1, h)}`) : (r = e.slice(a + 1, h)),
              (o = h - a - 1);
          (a = h), (s = 0);
        } else 46 === l && -1 !== s ? ++s : (s = -1);
      }
    ...
    function Y(e, t) {
      if (null === t || 'object' != typeof t) throw new F('pathObject', 'Object', t);
    ...
    const $ = {
        resolve(...e) {
          ...
          for (let r = e.length - 1; r >= -1; r--) {
            let o;
            if (r >= 0) {
              if (((o = e[r]), B(o, 'path'), 0 === o.length)) continue;
            } else
              0 === t.length
                ? (o = q.a())
                : ((o = q.b['=' + t] || q.a()),
            ...
            if (1 === a) j(c) && ((s = 1), (h = !0));
              ...
              if (((h = !0), j(o.charCodeAt(1)))) {
                let e = 2,
                  t = e;
                for (; e < a && !j(o.charCodeAt(e)); ) e++;
                if (e < a && e !== t) {
                  const n = o.slice(t, e);
                  for (t = e; e < a && j(o.charCodeAt(e)); ) e++;
                  if (e < a && e !== t) {
                    for (t = e; e < a && !j(o.charCodeAt(e)); ) e++;
              ...
              V(c) &&
                58 === o.charCodeAt(1) &&
                ((l = o.slice(0, 2)), (s = 2), a > 2 && j(o.charCodeAt(2)) && ((h = !0), (s = 3)));
            if (l.length > 0)
              if (t.length > 0) {
            ...
            if (i) {
              if (t.length > 0) break;
            } else if (((n = `${o.slice(s)}\\${n}`), (i = h), h && t.length > 0)) break;
          }
          return (n = K(n, !i, '\\', j)), i ? `${t}\\${n}` : `${t}${n}` || '.';
        },
        normalize(e) {
          B(e, 'path');
          const t = e.length;
          ...
          if (j(o))
            if (((r = !0), j(e.charCodeAt(1)))) {
              let r = 2,
                o = r;
              for (; r < t && !j(e.charCodeAt(r)); ) r++;
              if (r < t && r !== o) {
                const a = e.slice(o, r);
                for (o = r; r < t && j(e.charCodeAt(r)); ) r++;
                if (r < t && r !== o) {
                  for (o = r; r < t && !j(e.charCodeAt(r)); ) r++;
            ...
            V(o) &&
              58 === e.charCodeAt(1) &&
              ((n = e.slice(0, 2)), (i = 2), t > 2 && j(e.charCodeAt(2)) && ((r = !0), (i = 3)));
          let a = i < t ? K(e.slice(i), !r, '\\', j) : '';
          return (
            0 !== a.length || r || (a = '.'),
            a.length > 0 && j(e.charCodeAt(t - 1)) && (a += '\\'),
        ...
        isAbsolute(e) {
          ...
          return j(n) || (t > 2 && V(n) && 58 === e.charCodeAt(1) && j(e.charCodeAt(2)));
        },
        join(...e) {
          ...
          for (let i = 0; i < e.length; ++i) {
            const r = e[i];
            B(r, 'path'), r.length > 0 && (void 0 === t ? (t = n = r) : (t += '\\' + r));
          }
          if (void 0 === t) return '.';
          let i = !0,
            r = 0;
          if ('string' == typeof n && j(n.charCodeAt(0))) {
            ++r;
            const e = n.length;
            e > 1 && j(n.charCodeAt(1)) && (++r, e > 2 && (j(n.charCodeAt(2)) ? ++r : (i = !1)));
          }
          if (i) {
            for (; r < t.length && j(t.charCodeAt(r)); ) r++;
            r >= 2 && (t = '\\' + t.slice(r));
          }
          return $.normalize(t);
        },
        relative(e, t) {
          ...
          if (u !== c) {
            ...
            a > c && (92 === e.charCodeAt(r + u) ? (d = u) : 2 === u && (d = 3)),
              -1 === d && (d = 0);
          }
          let p = '';
          for (u = r + d + 1; u <= o; ++u)
            (u !== o && 92 !== e.charCodeAt(u)) || (p += 0 === p.length ? '..' : '\\..');
          return (
            (s += d),
            p.length > 0 ? `${p}${i.slice(s, l)}` : (92 === i.charCodeAt(s) && ++s, i.slice(s, l))
          );
        },
        toNamespacedPath(e) {
          ...
          } else if (V(t.charCodeAt(0)) && 58 === t.charCodeAt(1) && 92 === t.charCodeAt(2))
            return '\\\\?\\' + t;
          return e;
        },
        dirname(e) {
          ...
          if (j(r)) {
            ...
            V(r) && 58 === e.charCodeAt(1) && ((n = t > 2 && j(e.charCodeAt(2)) ? 3 : 2), (i = n));
          let o = -1,
            a = !0;
          for (let n = t - 1; n >= i; --n)
            if (j(e.charCodeAt(n))) {
        ...
        basename(e, t) {
          ...
          let n,
            ...
            o = !0;
          if (
            (e.length >= 2 && V(e.charCodeAt(0)) && 58 === e.charCodeAt(1) && (i = 2),
            ...
            for (n = e.length - 1; n >= i; --n) {
              ...
              if (j(l)) {
                ...
                -1 === s && ((o = !1), (s = n + 1)),
                  a >= 0 && (l === t.charCodeAt(a) ? -1 == --a && (r = n) : ((a = -1), (r = s)));
            }
        ...
        extname(e) {
          ...
          let t = 0,
            ...
            o = !0,
            a = 0;
          e.length >= 2 && 58 === e.charCodeAt(1) && V(e.charCodeAt(0)) && (t = i = 2);
          ...
          return -1 === n || -1 === r || 0 === a || (1 === a && n === r - 1 && n === i + 1)
            ? ''
            : e.slice(n, r);
        },
        format: Y.bind(null, '\\'),
        parse(e) {
          ...
          let i = 0,
            r = e.charCodeAt(0);
          if (1 === n) return j(r) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
          if (j(r)) {
            if (((i = 1), j(e.charCodeAt(1)))) {
              let t = 2,
                r = t;
              for (; t < n && !j(e.charCodeAt(t)); ) t++;
              if (t < n && t !== r) {
                for (r = t; t < n && j(e.charCodeAt(t)); ) t++;
                if (t < n && t !== r) {
                  for (r = t; t < n && !j(e.charCodeAt(t)); ) t++;
                  t === n ? (i = t) : t !== r && (i = t + 1);
                }
          ...
          for (; h >= i; --h)
            if (((r = e.charCodeAt(h)), j(r))) {
              ...
              -1 === s && ((l = !1), (s = h + 1)),
                46 === r ? (-1 === o ? (o = h) : 1 !== c && (c = 1)) : -1 !== o && (c = -1);
          return (
            -1 !== s &&
              (-1 === o || 0 === c || (1 === c && o === s - 1 && o === a + 1)
                ? (t.base = t.name = e.slice(a, s))
                : ((t.name = e.slice(a, o)), (t.base = e.slice(a, s)), (t.ext = e.slice(o, s)))),
      ...
      X = {
        resolve(...e) {
          ...
          for (let i = e.length - 1; i >= -1 && !n; i--) {
            const r = i >= 0 ? e[i] : q.a();
            B(r, 'path'), 0 !== r.length && ((t = `${r}/${t}`), (n = 47 === r.charCodeAt(0)));
          }
          return (t = K(t, !n, '/', G)), n ? '/' + t : t.length > 0 ? t : '.';
        },
        normalize(e) {
          if ((B(e, 'path'), 0 === e.length)) return '.';
          const t = 47 === e.charCodeAt(0),
            n = 47 === e.charCodeAt(e.length - 1);
          return 0 === (e = K(e, !t, '/', G)).length
            ? t
              ? '/'
              : n
              ? './'
        ...
        join(...e) {
          ...
          for (let n = 0; n < e.length; ++n) {
            const i = e[n];
            B(i, 'path'), i.length > 0 && (void 0 === t ? (t = i) : (t += '/' + i));
          }
          return void 0 === t ? '.' : X.normalize(t);
        },
        relative(e, t) {
          if ((B(e, 'from'), B(t, 'to'), e === t)) return '';
          if ((e = X.resolve(e)) === (t = X.resolve(t))) return '';
          const n = e.length,
            i = n - 1,
            r = t.length - 1,
            o = i < r ? i : r;
          ...
          if (s === o)
            ...
            } else i > o && (47 === e.charCodeAt(1 + s) ? (a = s) : 0 === s && (a = 0));
          let l = '';
          for (s = 1 + a + 1; s <= n; ++s)
        ...
        extname(e) {
          ...
          return -1 === t || -1 === i || 0 === o || (1 === o && t === i - 1 && t === n + 1)
            ? ''
            : e.slice(t, i);
        },
        format: Y.bind(null, '/'),
        parse(e) {
          ...
          if (-1 !== a) {
            ...
            -1 === r || 0 === h || (1 === h && r === a - 1 && r === o + 1)
              ...
              : ((t.name = e.slice(i, r)), (t.base = e.slice(i, a)), (t.ext = e.slice(r, a)));
          }
    ...
    (X.win32 = $.win32 = $), (X.posix = $.posix = X);
    'win32' === q.c ? $.normalize : X.normalize,
      'win32' === q.c ? $.resolve : X.resolve,
      'win32' === q.c ? $.relative : X.relative,
      'win32' === q.c ? $.dirname : X.dirname,
      'win32' === q.c ? $.basename : X.basename,
      'win32' === q.c ? $.extname : X.extname,
      'win32' === q.c ? $.sep : X.sep;
    const J = /^\w[\w\d+.-]*$/,
      Q = /^\//,
      Z = /^\/\//;
    ...
    class ie {
      ...
      static parse(e, t = !1) {
        const n = ne.exec(e);
        return n
          ? new oe(n[2] || '', ue(n[4] || ''), ue(n[5] || ''), ue(n[7] || ''), ue(n[9] || ''), t)
          : new oe('', '', '', '', '');
      }
      static file(e) {
        let t = '';
        if ((v.d && (e = e.replace(/\\/g, te)), e[0] === te && e[1] === te)) {
      ...
      static revive(e) {
        if (e) {
          ...
          {
            const t = new oe(e);
            return (t._formatted = e.external), (t._fsPath = e._sep === re ? e.fsPath : null), t;
          }
        }
        return e;
      }
    }
    const re = v.d ? 1 : void 0;
    class oe extends ie {
      constructor() {
      ...
      toJSON() {
        const e = { $mid: 1 };
        return (
          this._fsPath && ((e.fsPath = this._fsPath), (e._sep = re)),
    ...
    function le(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        35 === i || 63 === i
          ? (void 0 === t && (t = e.substr(0, n)), (t += ae[i]))
          : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
    ...
    function ce(e, t) {
      ...
      if ((r && ((i += r), (i += ':')), (o || 'file' === r) && ((i += te), (i += te)), o)) {
        let e = o.indexOf('@');
        if (-1 !== e) {
      ...
      return s && ((i += '?'), (i += n(s, !1))), l && ((i += '#'), (i += t ? l : se(l, !1))), i;
    }
    const de = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function ue(e) {
      return e.match(de)
        ? e.replace(de, (e) =>
            (function e(t) {
    ...
    class pe {
      ...
      with(e = this.lineNumber, t = this.column) {
        return e === this.lineNumber && t === this.column ? this : new pe(e, t);
      }
      delta(e = 0, t = 0) {
      ...
      isBeforeOrEqual(e) {
        return pe.isBeforeOrEqual(this, e);
      }
      ...
      clone() {
        return new pe(this.lineNumber, this.column);
      }
      toString() {
        return '(' + this.lineNumber + ',' + this.column + ')';
      }
      static lift(e) {
        return new pe(e.lineNumber, e.column);
      }
    ...
    class me {
      ...
      static intersectRanges(e, t) {
        ...
        return (
          ...
          n > r || (n === r && i > o) ? null : new me(n, i, r, o)
        );
      }
      equalsRange(e) {
      ...
      static getEndPosition(e) {
        return new pe(e.endLineNumber, e.endColumn);
      }
      getStartPosition() {
        return me.getStartPosition(this);
      }
      static getStartPosition(e) {
        return new pe(e.startLineNumber, e.startColumn);
      }
      toString() {
        return (
          '[' +
    ...
    function fe(e, t, n, i) {
      return new P(e, t, n).ComputeDiff(i);
    }
    class ge {
      constructor(e) {
        const t = [],
          n = [];
        for (let i = 0, r = e.length; i < r; i++) (t[i] = ye(e[i], 1)), (n[i] = Te(e[i], 1));
      ...
      createCharSequence(e, t, n) {
        ...
        for (let s = t; s <= n; s++) {
          ...
          for (let e = n; e < l; e++) (i[a] = t.charCodeAt(e - 1)), (r[a] = s + 1), (o[a] = e), a++;
        }
        return new be(i, r, o);
      }
    }
      ...
      static createFromDiffResult(e, t, n, i, r, o, a) {
        ...
        if (
          ...
          a &&
            ...
            (d = []);
          for (let e = 0, t = l.length; e < t; e++) d.push(_e.createFromDiffChange(l[e], o, s));
        }
        return new ve(s, l, h, c, d);
      }
    }
    class we {
      constructor(e, t, n) {
        (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
          ...
          (this.original = new ge(e)),
          (this.modified = new ge(t)),
          (this.continueLineDiff = ke(n.maxComputationTime)),
          (this.continueCharDiff = ke(
      ...
      _pushTrimWhitespaceCharChange(e, t, n, i, r, o, a) {
        ...
        let s = void 0;
        this.shouldComputeCharChanges && (s = [new _e(t, n, t, i, r, o, r, a)]),
          e.push(new ve(t, t, r, r, s));
      }
      _mergeTrimWhitespaceCharChange(e, t, n, i, r, o, a) {
        ...
        return (
          ...
          this.shouldComputeCharChanges &&
            l.charChanges &&
            l.charChanges.push(new _e(t, n, t, i, r, o, r, a)),
          !0)
        );
      }
    }
    ...
    class Ce {
      ...
      getIndexOf(e) {
        ...
        for (; t <= n; )
          if (
            ((i = (t + (n - t) / 2) | 0), (r = this.prefixSum[i]), (o = r - this.values[i]), e < o)
          )
            n = i - 1;
          else {
            if (!(e >= r)) break;
    ...
    class Re {
      constructor(e) {
        let t = Se(e);
        (this._defaultValue = t), (this._asciiMap = Re._createAsciiMap(t)), (this._map = new Map());
      }
      ...
      static computeLinks(
        ...
        const n = (function () {
          if (null === He) {
            He = new Re(0);
            const e = ' \t<>\'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…';
            for (let t = 0; t < e.length; t++) He.set(e.charCodeAt(t), 1);
            const t = '.,;';
            for (let e = 0; e < t.length; e++) He.set(t.charCodeAt(e), 2);
          }
          return He;
        })();
        let i = [];
        for (let r = 1, o = e.getLineCount(); r <= o; r++) {
          ...
          for (; s < a; ) {
            ...
            if (13 === c) {
              ...
              1 === t && (i.push(ze._createLink(n, o, r, l, s)), (e = !0));
            } else if (12 === c) {
              let t;
              91 === a ? ((u = !0), (t = 0)) : (t = n.get(a)), 1 === t ? (e = !0) : (c = 13);
            } else (c = t.nextState(c, a)), 0 === c && (e = !0);
            e && ((c = 1), (d = !1), (u = !1), (m = !1), (l = s + 1), (h = a)), s++;
          }
          13 === c && i.push(ze._createLink(n, o, r, l, a));
        }
        return i;
      }
    }
    ...
    class De {
      ...
      clear() {
        ...
        for (; e !== Oe.Undefined; ) {
          const t = e.next;
          (e.prev = Oe.Undefined), (e.next = Oe.Undefined), (e = t);
        }
        (this._first = Oe.Undefined), (this._last = Oe.Undefined), (this._size = 0);
      }
      unshift(e) {
      ...
      _insert(e, t) {
        const n = new Oe(e);
        if (this._first === Oe.Undefined) (this._first = n), (this._last = n);
        else if (t) {
          const e = this._last;
      ...
      _remove(e) {
        if (e.prev !== Oe.Undefined && e.next !== Oe.Undefined) {
          ...
          e.prev === Oe.Undefined && e.next === Oe.Undefined
            ? ((this._first = Oe.Undefined), (this._last = Oe.Undefined))
            : e.next === Oe.Undefined
            ? ((this._last = this._last.prev), (this._last.next = Oe.Undefined))
            : e.prev === Oe.Undefined &&
              ((this._first = this._first.next), (this._first.prev = Oe.Undefined));
        this._size -= 1;
      }
      *[Symbol.iterator]() {
        let e = this._first;
    ...
    const Pe = v.a.performance && 'function' == typeof v.a.performance.now;
    class qe {
      constructor(e) {
        (this._highResolution = Pe && e), (this._startTime = this._now()), (this._stopTime = -1);
      }
      static create(e = !0) {
        return new qe(e);
      }
      ...
      _now() {
        return this._highResolution ? v.a.performance.now() : Date.now();
      }
    }
    var Fe;
    !(function (e) {
          ...
          onFirstListenerAdd() {
            o = e((e) => {
              l++,
                ...
                (s = setTimeout(() => {
                  const e = a;
                  (a = void 0), (s = void 0), (!i || l > 1) && h.fire(e), (l = 0);
                }, n));
            });
          },
          onLastListenerRemove() {
    ...
    class Be {
      ...
      start(e) {
        (this._stopWatch = new qe(!0)), (this._listenerCount = e);
      }
      stop() {
        if (this._stopWatch) {
    ...
    class je {
        ...
        return (
          this._event ||
            (this._event = (e, t, n) => {
              ...
              return n instanceof b ? n.add(s) : Array.isArray(n) && n.push(s), s;
            }),
          this._event
        );
      }
      ...
      dispose() {
        ...
        this._disposed ||
          ...
          null ===
            (i = null === (n = this._options) || void 0 === n ? void 0 : n.onLastListenerRemove) ||
            void 0 === i ||
            i.call(n),
    ...
    var Ve, Ke;
    ((Ke = Ve || (Ve = {})).isCancellationToken = function (e) {
      return (
        e === Ke.None ||
        e === Ke.Cancelled ||
        e instanceof Ye ||
      ...
      (Ke.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: Fe.None })),
      (Ke.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: Ge }));
    class Ye {
      constructor() {
      ...
      get onCancellationRequested() {
        return this._isCancelled
          ? Ge
          : (this._emitter || (this._emitter = new je()), this._emitter.event);
      }
      dispose() {
    ...
    !(function () {
      function e(e, t, n = t, i = n) {
        Je.define(e, t), Qe.define(e, n), Ze.define(e, i);
      }
      e(0, 'unknown'),
        e(1, 'Backspace'),
        e(2, 'Tab'),
      ...
      (function (e) {
        (e.toString = function (e) {
          ...
          (e.fromUserSettings = function (e) {
            return Qe.strToKeyCode(e) || Ze.strToKeyCode(e);
          });
      })(et || (et = {}));
    class zt extends me {
      constructor(e, t, n, i) {
      ...
      setEndPosition(e, t) {
        return 0 === this.getDirection()
          ? new zt(this.startLineNumber, this.startColumn, e, t)
          : new zt(e, t, this.startLineNumber, this.startColumn);
      }
      getPosition() {
      ...
      setStartPosition(e, t) {
        return 0 === this.getDirection()
          ? new zt(e, t, this.endLineNumber, this.endColumn)
          : new zt(this.endLineNumber, this.endColumn, e, t);
      }
      static fromPositions(e, t = e) {
      ...
      static createWithDirection(e, t, n, i, r) {
        return 0 === r ? new zt(e, t, n, i) : new zt(n, i, e, t);
      }
    }
    class Wt {
      constructor(e, t, n) {
    ...
    (Ot.CtrlCmd = 2048), (Ot.Shift = 1024), (Ot.Alt = 512), (Ot.WinCtrl = 256);
    ...
    class Pt extends class {
      ...
      onEvents(e) {
        ...
        for (const e of t)
          this._acceptDeleteRange(e.range),
            this._acceptInsertText(new pe(e.range.startLineNumber, e.range.startColumn), e.text);
      ...
      getWordAtPosition(e, t) {
        let n = (function e(t, n, i, r, o = Ae) {
          if (i.length > o.maxLen) {
            let a = t - o.maxLen / 2;
            return (
              a < 0 ? (a = 0) : (r += a), e(t, n, (i = i.substring(a, t + o.maxLen / 2)), r, o)
            );
          }
          const a = Date.now(),
            s = t - 1 - r;
    ...
    class qt {
      ...
      acceptNewModel(e) {
        this._models[e.url] = new Pt(ie.parse(e.url), e.lines, e.EOL, e.versionId);
      }
      ...
      computeMoreMinimalEdits(e, t) {
        return Dt(this, void 0, void 0, function* () {
          ...
          for (let { range: e, text: o, eol: a } of t) {
            if (('number' == typeof a && (r = a), me.isEmpty(e) && !o)) continue;
            const t = n.getValueInRange(e);
            if (((o = o.replace(/\r\n|\n|\r/g, n.eol)), t === o)) continue;
            if (Math.max(o.length, t.length) > qt._diffLimit) {
              i.push({ range: e, text: o });
              continue;
            }
            const s = z(t, o, !1),
              l = n.offsetAt(me.lift(e).getStartPosition());
            for (const e of s) {
          ...
          e: for (let n of e) {
            ...
            if (e)
              for (let n of e.words(o))
                if (n !== t && isNaN(Number(n)) && (a.add(n), a.size > qt._suggestionsLimit))
                  break e;
          }
      ...
      navigateValueSet(e, t, n, i, r) {
        return Dt(this, void 0, void 0, function* () {
          ...
          return We.INSTANCE.navigateValueSet(t, s, l, h, n);
        });
      }
        ...
        (i = (() => {
          var t = {
              470: (t) => {
                  ...
                  for (var n, i = '', r = 0, o = -1, a = 0, s = 0; s <= e.length; ++s) {
                    ...
                    if (47 === n) {
                      if (o === s - 1 || 1 === a);
                        ...
                        if (
                          ...
                          if (i.length > 2) {
                            ...
                            if (l !== i.length - 1) {
                              -1 === l
                                ? ((i = ''), (r = 0))
                                : (r = (i = i.slice(0, l)).length - 1 - i.lastIndexOf('/')),
                                (o = s),
                                (a = 0);
                              continue;
                            }
                        ...
                        i.length > 0 ? (i += '/' + e.slice(o + 1, s)) : (i = e.slice(o + 1, s)),
                          (r = s - o - 1);
                      (o = s), (a = 0);
                    } else 46 === n && -1 !== a ? ++a : (a = -1);
                  }
                ...
                var r = {
                  resolve: function () {
                    for (var t, r = '', o = !1, a = arguments.length - 1; a >= -1 && !o; a--) {
                      var s;
                    ...
                    return (
                      (r = i(r, !o)), o ? (r.length > 0 ? '/' + r : '/') : r.length > 0 ? r : '.'
                    );
                  },
                  ...
                  join: function () {
                    ...
                    for (var e, t = 0; t < arguments.length; ++t) {
                      var i = arguments[t];
                      n(i), i.length > 0 && (void 0 === e ? (e = i) : (e += '/' + i));
                    }
                  ...
                  relative: function (e, t) {
                    ...
                    for (var l = t.length - s, h = a < l ? a : l, c = -1, d = 0; d <= h; ++d) {
                      if (d === h) {
                        if (l > h) {
                          if (47 === t.charCodeAt(s + d)) return t.slice(s + d + 1);
                          if (0 === d) return t.slice(s + d);
                        } else a > h && (47 === e.charCodeAt(i + d) ? (c = d) : 0 === d && (c = 0));
                        break;
                      }
                  ...
                  dirname: function (e) {
                    if ((n(e), 0 === e.length)) return '.';
                    for (
                      var t = e.charCodeAt(0), i = 47 === t, r = -1, o = !0, a = e.length - 1;
                      a >= 1;
                      --a
                    )
                    ...
                    if (void 0 !== t && t.length > 0 && t.length <= e.length) {
                      ...
                      for (i = e.length - 1; i >= 0; --i) {
                        ...
                        if (47 === h) {
                          ...
                          -1 === l && ((a = !1), (l = i + 1)),
                            s >= 0 &&
                              (h === t.charCodeAt(s) ? -1 == --s && (o = i) : ((s = -1), (o = l)));
                      }
                  ...
                  extname: function (e) {
                    n(e);
                    for (var t = -1, i = 0, r = -1, o = !0, a = 0, s = e.length - 1; s >= 0; --s) {
                  ...
                  parse: function (e) {
                    ...
                    var i,
                      ...
                      o = 47 === r;
                    o ? ((t.root = '/'), (i = 1)) : (i = 0);
                    for (var a = -1, s = 0, l = -1, h = !0, c = e.length - 1, d = 0; c >= i; --c)
                    ...
                    return (
                      -1 === a || -1 === l || 0 === d || (1 === d && a === l - 1 && a === s + 1)
                        ? -1 !== l &&
                          (t.base = t.name = 0 === s && o ? e.slice(1, l) : e.slice(s, l))
                        : (0 === s && o
                            ? ((t.name = e.slice(1, a)), (t.base = e.slice(1, l)))
                            : ((t.name = e.slice(s, a)), (t.base = e.slice(s, l))),
                          (t.ext = e.slice(a, l))),
              ...
              447: (t, n, i) => {
                var r;
                if ((i.r(n), i.d(n, { URI: () => f, Utils: () => x }), 'object' == typeof e))
                  r = 'win32' === e.platform;
                    ...
                    return (
                      ...
                      (e.prototype.with = function (e) {
                        ...
                        return (
                          ...
                          void 0 === i ? (i = this.path) : null === i && (i = u),
                          void 0 === r ? (r = this.query) : null === r && (r = u),
                      ...
                      (e.from = function (e) {
                        return new b(e.scheme, e.authority, e.path, e.query, e.fragment);
                      }),
                    ...
                    return (
                      ...
                      (t.prototype.toString = function (e) {
                        return (
                          ...
                          e
                            ? T(this, !0)
                            : (this._formatted || (this._formatted = T(this, !1)), this._formatted)
                        );
                      }),
                ...
                function v(e, t) {
                  ...
                  return (
                    -1 !== i && (n += encodeURIComponent(e.substring(i))), void 0 !== n ? n : e
                  );
                }
                function w(e) {
  ...
  function (e, t, n) {
    ...
    !(function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n, i) {
          if (ue.uinteger(e) && ue.uinteger(t) && ue.uinteger(n) && ue.uinteger(i))
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return ue.defined(t) && a.is(t.range) && (ue.string(t.uri) || ue.undefined(t.uri));
          });
      })(s || (s = {})),
      (function (e) {
        (e.create = function (e, t, n, i) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (a.is(t.targetSelectionRange) || ue.undefined(t.targetSelectionRange)) &&
              (a.is(t.originSelectionRange) || ue.undefined(t.originSelectionRange))
            );
          });
      })(l || (l = {})),
      (function (e) {
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (ue.undefined(t.additionalTextEdits) || ue.typedArray(t.additionalTextEdits, w.is))
            );
          });
      })(d || (d = {})),
      (function (e) {
        ...
        (e.create = function (e, t, n, i, r, o) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (ue.integer(n.code) || ue.string(n.code) || ue.undefined(n.code)) &&
              (ue.undefined(n.codeDescription) ||
                ue.string(null === (t = n.codeDescription) || void 0 === t ? void 0 : t.href)) &&
              (ue.string(n.source) || ue.undefined(n.source)) &&
              (ue.undefined(n.relatedInformation) || ue.typedArray(n.relatedInformation, m.is))
            );
          });
      })(_ || (_ = {})),
      (function (e) {
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              ue.objectLiteral(t) &&
              ue.string(t.label) &&
              (ue.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return ue.defined(t) && H.is(t.textDocument) && Array.isArray(t.edits);
          });
      })(S || (S = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              ue.string(t.uri) &&
              (void 0 === t.options ||
                ((void 0 === t.options.overwrite || ue.boolean(t.options.overwrite)) &&
                  (void 0 === t.options.ignoreIfExists || ue.boolean(t.options.ignoreIfExists)))) &&
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              ue.string(t.uri) &&
              (void 0 === t.options ||
                ((void 0 === t.options.recursive || ue.boolean(t.options.recursive)) &&
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function (e) {
                return ue.string(e.kind) ? x.is(e) || L.is(e) || C.is(e) : S.is(e);
              }))
          );
        };
      })(E || (E = {}));
      ...
      ce = (function () {
        ...
        return (
          ...
          (e.prototype.manage = function (e, t) {
            var n;
            if (
              (T.is(e) ? (n = e) : ((n = this.nextId()), (t = e)), void 0 !== this._annotations[n])
            )
      ...
      Object.defineProperty(e.prototype, 'edit', {
        ...
        (e.prototype.getTextEditChange = function (e) {
          ...
          if (!(i = this._textEditChanges[e])) {
            var r = [];
            (this._workspaceEdit.changes[e] = r), (i = new he(r)), (this._textEditChanges[e] = i);
          }
          return i;
        }),
        ...
        (e.prototype.createFile = function (e, t, n) {
          ...
          if (
            ...
            void 0 === i
              ? (r = x.create(e, n))
              : ((o = T.is(i) ? i : this._changeAnnotations.manage(i)), (r = x.create(e, n, o))),
        ...
        (e.prototype.renameFile = function (e, t, n, i) {
          ...
          if (
            ...
            void 0 === r
              ? (o = L.create(e, t, i))
              : ((a = T.is(r) ? r : this._changeAnnotations.manage(r)), (o = L.create(e, t, i, a))),
        ...
        (e.prototype.deleteFile = function (e, t, n) {
          ...
          if (
            ...
            void 0 === i
              ? (r = C.create(e, n))
              : ((o = T.is(i) ? i : this._changeAnnotations.manage(i)), (r = C.create(e, n, o))),
            this._workspaceEdit.documentChanges.push(r),
            void 0 !== o)
          )
            return o;
    ...
    !(function (e) {
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              ue.defined(t) && ue.string(t.uri) && (null === t.version || ue.integer(t.version))
            );
          });
      })(H || (H = {})),
      (function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return t && ue.string(t.newText) && a.is(t.insert) && a.is(t.replace);
          });
      })(F || (F = {})),
      (function (e) {
      ...
      (function (e) {
        (e.fromPlainText = function (e) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              ue.string(t) || (ue.objectLiteral(t) && ue.string(t.language) && ue.string(t.value))
            );
          });
      })(V || (V = {})),
      (function (e) {
        e.is = function (e) {
          ...
          return (
            !!t &&
            ue.objectLiteral(t) &&
            (O.is(t.contents) || V.is(t.contents) || ue.typedArray(t.contents, V.is)) &&
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              t &&
              ue.string(t.title) &&
              (void 0 === t.diagnostics || ue.typedArray(t.diagnostics, _.is)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return ue.defined(t) && a.is(t.range) && (ue.undefined(t.command) || v.is(t.command));
          });
      })(oe || (oe = {})),
      (function (e) {
        (e.create = function (e, t) {
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              ue.defined(t) && a.is(t.range) && (ue.undefined(t.target) || ue.string(t.target))
            );
          });
      })(se || (se = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (t) {
            var n = t;
            return void 0 !== n && a.is(n.range) && (void 0 === n.parent || e.is(n.parent));
          });
      })(le || (le = {}));
    var de;
    !(function (e) {
      (e.create = function (e, t, n, i) {
        ...
        (e.applyEdits = function (e, t) {
          for (
            ...
            (n = n.substring(0, s) + a.newText + n.substring(l, n.length)), (r = s);
          }
          return n;
        });
    })(de || (de = {}));
    ...
    var me,
      ...
      ve = (function () {
        ...
        return (
          ...
          (e.prototype.getLineOffsets = function () {
            return (
              void 0 === this._lineOffsets && (this._lineOffsets = we(this._content, !0)),
              this._lineOffsets
            );
          }),
          (e.prototype.positionAt = function (e) {
    ...
    function we(e, t, n) {
      ...
      for (var i = t ? [n] : [], r = 0; r < e.length; r++) {
        var o = e.charCodeAt(r);
        (13 !== o && 10 !== o) ||
          (13 === o && r + 1 < e.length && 10 === e.charCodeAt(r + 1) && r++, i.push(n + r + 1));
      }
      return i;
    }
    function ye(e) {
    ...
    !(function (e) {
      ...
      ((be || (be = {})).LATEST = {
        textDocument: {
          completion: { completionItem: { documentationFormat: [W.Markdown, W.PlainText] } },
    ...
    function De(e, t, n, i) {
      void 0 === t && (t = 0), void 0 === n && (n = ge.WithinContent), void 0 === i && (i = !1);
      var r,
        o,
        a,
        s,
            ...
            n = (function e() {
              ...
              switch (c) {
                ...
                case ge.AfterOpeningEndTag:
                  return p().length > 0
                    ...
                    : ((c = ge.WithinEndTag),
                      ...
                      n < h.pos()
                        ? m(n, fe.Unknown, ke('error.endTagNameExpected', 'End tag name expected.'))
                        : e());
                case ge.WithinEndTag:
                  if (h.skipWhitespace()) return m(n, fe.Whitespace);
                  if (h.advanceIfChar(Ee)) return (c = ge.WithinContent), m(n, fe.EndTagClose);
                  if (i && h.peekChar() === Ce)
                    return (
                      (c = ge.WithinContent),
                      m(
                        n,
                        fe.EndTagClose,
                        ke('error.closingBracketMissing', 'Closing bracket missing.'),
                      )
                    );
                  t = ke('error.closingBracketExpected', 'Closing bracket expected.');
                  break;
                      ...
                      : ((c = ge.WithinTag),
                        ...
                        n < h.pos()
                          ? m(
                              n,
                              fe.Unknown,
                              ke('error.startTagNameExpected', 'Start tag name expected.'),
                            )
                          : e())
                  );
                case ge.WithinTag:
                  return h.skipWhitespace()
                    ...
                    : o &&
                      (s = h.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase())
                        .length > 0
                    ? ((c = ge.AfterAttributeName), (o = !1), m(n, fe.AttributeName))
                    ...
                    : (h.advance(1),
                      m(
                        n,
                        fe.Unknown,
                        ke('error.unexpectedCharacterInTag', 'Unexpected character in tag.'),
                      ));
                ...
                case ge.BeforeAttributeValue:
                  ...
                  return d === Ie || d === Re
                    ? (h.advance(1),
                      ...
                      'type' === s && (l = h.getSource().substring(n + 1, h.pos() - 1)),
                      (c = ge.WithinTag),
                      (o = !1),
                      m(n, fe.AttributeValue))
                ...
                case ge.WithinScriptContent:
                  ...
                  return (c = ge.WithinContent), n < h.pos() ? m(n, fe.Script) : e();
      ...
      for (
        ...
        switch (s) {
          ...
          case fe.AttributeName:
            (a = t.getTokenText()), (c = i.attributes) || (i.attributes = c = {}), (c[a] = null);
            break;
    ...
    function et(e, t) {
      ...
      return (Ye <= n && n <= $e) || (Xe <= n && n <= Je) || (Qe <= n && n <= Ze);
    }
    function tt(e) {
      return void 0 !== e;
    }
                ...
                switch (p.label) {
                  ...
                  case 1:
                    return i < r.length
                      ? ((o = r[i]),
                        (function (e) {
                          if (Ve(e, 'http') || Ve(e, 'https') || Ve(e, '//')) return !1;
                          return !0;
                        })(
                          (s = (function (e) {
                      ...
                      (l = (function (e, t, n) {
                        ...
                        if (-1 === r)
                          ...
                          var o = t.slice(r + 1),
                            ...
                            l = o.indexOf(' '),
                            h = void 0;
                          (h = -1 !== l ? ht(s, l) : ht(n.end, -1)), (i = a.create(s, h));
                        }
                        return i;
                      })(o.value, s, o.range)),
                  ...
                  case 3:
                    for (h = p.sent(), c = 0, d = h; c < d.length; c++) (u = d[c]), n.items.push(u);
                    p.label = 4;
                  case 4:
                    return i++, [3, 1];
                  case 5:
              ...
              return ot(this, function (p) {
                switch (p.label) {
                  case 0:
                    ...
                    p.label = 1;
                  case 1:
                    return p.trys.push([1, 3, , 4]), (a = []), [4, this.readDirectory(o)];
                  case 2:
                    for (s = p.sent(), l = 0, h = s; l < h.length; l++)
                      (c = h[l]),
                        (d = c[0]),
                        (u = c[1]),
                        d.charCodeAt(0) !== st && a.push(lt(d, u === _e.Directory, t));
                    return [2, a];
                  case 3:
                    return p.sent(), [3, 4];
                  case 4:
        ...
        return (
              ...
              return ut(this, function (h) {
                switch (h.label) {
                  case 0:
                    ...
                    (o = new at(this.lsOptions.fileSystemProvider.readDirectory)),
                      (a = this.completionParticipants),
                      (this.completionParticipants = [o].concat(a)),
                      (s = this.doComplete(e, t, n, r)),
                      (h.label = 1);
                  case 1:
                    return h.trys.push([1, , 3, 4]), [4, o.computeCompletions(e, i)];
                  case 2:
                    return (
                      (l = h.sent()),
                      [
          ...
          (e.prototype._doComplete = function (e, t, n, i) {
              ...
              for (t && (a = a.parent); a; ) {
                ...
                if (s && (!a.closed || (a.endTagStart && a.endTagStart > d))) {
                  ...
                  if (null !== m && null !== f && m !== f) {
                    var b = m + '</' + s + o;
                    (p.textEdit = w.replace(g(e - 1 - f.length), b)), (p.filterText = f + '</' + s);
                  }
            ...
            function k(e, t) {
              ...
              var o,
                a = c.substring(e, t),
                s = g(e, i),
                p = gt(c, t, ge.AfterAttributeName, fe.DelimiterAssign) ? '' : '="$1"',
                m =
            ...
            function S(n, i) {
              var o, a, u, m;
              if ((void 0 === i && (i = d), d > n && d <= i && ((m = c[n]), /^["']*$/.test(m)))) {
                var b = n + 1,
                  _ = i;
                i > n && c[i - 1] === c[n] && _--;
                ...
                (o = g(v, y)), (u = d >= b && d <= _ ? c.substring(b, d) : ''), (a = !1);
              } else (o = g(n, i)), (u = c.substring(n, d)), (a = !0);
              if (s.length > 0)
                for (
                  var T = f.toLowerCase(), k = p.toLowerCase(), S = g(n, i), x = 0, L = s;
                  x < L.length;
                  x++
                ) {
                  var E = L[x];
            ...
            function x(e) {
              return d === m.getTokenEnd() && (A = m.scan()) === e && m.getTokenOffset() === d
                ? m.getTokenEnd()
                : d;
            }
            function L() {
            ...
            function C() {
              for (var e, n, i, s = d - 1, l = t.character; s >= 0 && et(c, s); ) s--, l--;
              if (s >= 0 && '&' === c[s]) {
            ...
            for (var E, A = m.scan(); A !== fe.EOS && m.getTokenOffset() <= d; ) {
              switch (A) {
                ...
                case fe.Whitespace:
                  ...
                  break;
                case fe.EndTagOpen:
                  if (d <= m.getTokenEnd()) return v(m.getTokenOffset() + 1, !1, x(fe.EndTag));
                  break;
                case fe.EndTag:
                  if (d <= m.getTokenEnd())
            ...
            if ('>' === r) {
              if (
                ...
                for (
                  ...
                  if (o === fe.StartTagClose && s.getTokenEnd() === i) return '$0</' + a.tag + '>';
                  o = s.scan();
                }
            } else if ('/' === r) {
              for (
              ...
              if (a && a.tag) {
                ...
                for (
                  ...
                  if (o === fe.EndTagOpen && s.getTokenEnd() === i) return a.tag + '>';
                  o = s.scan();
                }
              }
            }
          ...
          (e.prototype.doesSupportMarkdown = function () {
            ...
            if (!tt(this.supportsMarkdown)) {
              ...
              var i =
                null ===
                  (n =
                    null ===
                      (t =
                        null === (e = this.lsOptions.clientCapabilities.textDocument) ||
                        void 0 === e
                          ? void 0
              ...
              this.supportsMarkdown = Array.isArray(i) && -1 !== i.indexOf(W.Markdown);
            }
    ...
    function gt(e, t, n, i) {
      for (var r = De(e, t, n), o = r.scan(); o === fe.Whitespace; ) o = r.scan();
      return o === i;
    }
    var bt,
      _t = I(),
          ...
          (e.prototype.doHover = function (e, t, n, i) {
                    ...
                    if (
                      (n.provideTags().forEach(function (n) {
                        if (n.name.toLowerCase() === e.toLowerCase()) {
                          var r = it(n, i, s);
                          r || (r = { kind: s ? 'markdown' : 'plaintext', value: '' }),
            ...
            function p(t, n) {
              for (
                ...
                r !== fe.EOS && (i.getTokenEnd() < l || (i.getTokenEnd() === l && r !== t));
            ...
            var b = (function () {
              for (var e = l - 1, n = t.character; e >= 0 && et(c, e); ) e--, n--;
            ...
            if (b)
              return (function (e, t) {
                ...
                for (var i in Ge) {
                  var o = null;
                  if (n === '&' + i) {
                    var a = Ge[i].charCodeAt(0).toString(16).toUpperCase(),
                      s = 'U+';
                    if (a.length < 4)
                      for (var h = 4 - a.length, c = 0; c < h; ) (s += '0'), (c += 1);
                    s += a;
                    var d = _t(
                      'entity.propose',
              ...
              var v = h.tag,
                ...
                y = (function (t, n) {
                  for (
                    ...
                    (r = i.scan()) === fe.AttributeName && (o = i.getTokenText());
                  return o;
              ...
              var i =
                null ===
                  (n =
                    null ===
                      (t =
                        null === (e = this.lsOptions.clientCapabilities) || void 0 === e
                          ? void 0
          ...
          function (e) {
            ...
            (n.prototype.restart = function () {
              ...
              (n.prototype.test = function (e, t) {
                return (
                  (t = t || 0),
                  (t += this.__position) >= 0 && t < this.__input_length && !!this.__match(e, t)
                );
              }),
          ...
          function (e, t, n) {
            ...
            (p.prototype.eatString = function (e) {
              ...
              (p.prototype.eatWhitespace = function (e) {
                for (var t = h.test(this._input.peek()), n = 0; h.test(this._input.peek()); )
                  (this._ch = this._input.next()),
                    e &&
                      '\n' === this._ch &&
              ...
              (p.prototype.beautify = function () {
                ...
                (this._output = new r(this._options, n)),
                  ...
                  (this._ch = null);
                for (
                  var i, p, m = 0, f = !1, g = !1, b = !1, _ = !1, v = !1, w = this._ch;
                  ...
                  if ('/' === this._ch && '*' === this._input.peek()) {
                    ...
                    T && 'start' === T.ignore && (y += a.readIgnored(this._input)),
                      this.print_string(y),
                    ...
                    if ((this.preserveSingleSpace(i), '{' === this._input.peek()))
                      ...
                      k.match(/[ :]$/) &&
                        ...
                        k in this.NESTED_AT_RULE
                          ? ((this._nestedLevel += 1), k in this.CONDITIONAL_GROUP_RULE && (b = !0))
                          : f || 0 !== m || -1 === k.indexOf(':') || ((g = !0), this.indent());
                    }
                  else
                    '#' === this._ch && '{' === this._input.peek()
                      ...
                      ? (this.print_string(this._ch),
                        this.eatWhitespace(!0),
                        !this._options.selector_separator_newline || g || 0 !== m || v || _
                          ? (this._output.space_before_token = !0)
                          : this._output.add_new_line())
                      : ('>' !== this._ch && '+' !== this._ch && '~' !== this._ch) || g || 0 !== m
                      ? ']' === this._ch
                        ? this.print_string(this._ch)
                        : '[' === this._ch
    ...
    function kt(e, t, n) {
      ...
      if (t) {
        ...
        (u === i.length || Ct(i, u)) && (d = u), (t = a.create(e.positionAt(h), e.positionAt(d)));
      ...
      var f = {
          ...
          wrap_attributes_indent_size: St(n, 'wrapAttributesIndentSize', void 0),
          eol: '\n',
          indent_scripts: St(n, 'indentScripts', 'normal'),
          templating: Lt(n, 'all'),
          unformatted_content_delimiter: St(n, 'unformattedContentDelimiter', ''),
        },
        g = (function (e, t) {
          return yt(e, t, wt, Tt);
        })(i.replace(/^\s+/, ''), f);
                ...
                a.isEmpty() || ((e.comments_before = a), (a = new o())),
                  ...
                  this._is_opening(e)
                    ...
                    : n &&
                      ...
                      ((e.opened = n), (n.closed = e), (n = i.pop()), (e.parent = n)),
                  (e.previous = t),
                  (t.next = e),
                  this.__tokens.add(e),
                  (t = e);
          ...
          function (e) {
            ...
            (t.prototype.restart = function () {
              ...
              (t.prototype.next = function () {
                var e = null;
                return (
                  this.hasNext() && ((e = this.__tokens[this.__position]), (this.__position += 1)),
                  e
                );
              }),
              (t.prototype.peek = function (e) {
                ...
                return (
                  (e = e || 0),
                  (e += this.__position) >= 0 && e < this.__tokens_length && (t = this.__tokens[e]),
                  t
                );
              }),
          ...
          function (e, t, n) {
                ...
                if (
                  ...
                  if (
                    (t.type === a.ATTRIBUTE
                      ...
                      : (t.type === a.EQUALS ||
                          (t.type === a.VALUE && t.previous.type === a.EQUALS)) &&
                ...
                if ('' !== t.text) {
                  ...
                  if (o)
                    if (r) {
                      ...
                      (d.prototype = this._options.raw_options), (o = r(h + o, new d()));
                    } else {
                      var u = t.whitespace_before;
                      u && (o = o.replace(new RegExp('\n(' + u + ')?', 'g'), '\n')),
                        (o = h + o.replace(/\n/g, '\n' + h));
                    }
                  s && (o = o ? s + o + '\n' + l : s + l),
                    e.print_newline(!1),
            ...
            (m.prototype._get_tag_open_token = function (e) {
              ...
              return (
                ...
                (t.is_end_tag = t.is_end_tag || d(t.tag_check, this._options.void_elements)),
                (t.is_empty_element = t.tag_complete || (t.is_start_tag && t.is_end_tag)),
                (t.is_unformatted = !t.tag_complete && d(t.tag_check, this._options.unformatted)),
                (t.is_content_unformatted =
                  !t.is_empty_element && d(t.tag_check, this._options.content_unformatted)),
                (t.is_inline_element =
                  d(t.tag_name, this._options.inline) || '{' === t.tag_start_char),
                t
              );
            }),
              ...
              if (!e.is_empty_element && e.is_start_tag && e.parent) {
                if ('body' === e.tag_name) t = t || this._tag_stack.try_pop('head');
                  ...
                  'rp' === e.tag_name || 'rt' === e.tag_name
                    ...
                    : 'option' === e.tag_name
                    ? (t =
                        t || this._tag_stack.try_pop('option', ['select', 'datalist', 'optgroup']))
                    : 'colgroup' === e.tag_name
                              ...
                              (n =
                                (n =
                                  (n =
                                    ...
                                    this._read_attribute(i, e, t)) || this._read_close(i, t)) ||
                                this._read_raw_content(i, e, t)) || this._read_content_word(i)) ||
    ...
    function Mt(e) {
      var t = e[0];
      return (
        t !== e[e.length - 1] || ("'" !== t && '"' !== t) || (e = e.substr(1, e.length - 2)), e
      );
    }
    function Rt(e, t, n, i, r, o) {
      ...
      if (
        ...
        if (
          ...
          return { range: a.create(e.positionAt(i), e.positionAt(r)), target: c };
      }
    }
    function It(e, t) {
      for (
        var n = [], i = De(e.getText(), 0), r = i.scan(), o = void 0, a = !1, s = void 0, l = {};
        r !== fe.EOS;
        ...
        switch (r) {
          ...
          case fe.AttributeValue:
            if ('src' === o || 'href' === o) {
              ...
              if (!a) (u = Rt(e, t, h, i.getTokenOffset(), i.getTokenEnd(), s)) && n.push(u);
              a && void 0 === s && (s = Mt(h)) && t && (s = t.resolveReference(s, e.uri)),
                (a = !1),
                (o = void 0);
            } else if ('id' === o) {
    ...
    function Ut(e, t, n) {
      ...
      return (
        ((a && Ht(a, t)) || (s && Ht(s, t))) &&
          (a && o.push({ kind: X.Read, range: a }), s && o.push({ kind: X.Read, range: s })),
        o
      );
    }
    function Nt(e, t) {
    ...
    function zt(e, t, n) {
      for (var i = De(t.getText(), n), r = i.scan(); r !== fe.EOS && r !== e; ) r = i.scan();
      return r !== fe.EOS
        ...
        t.roots.forEach(function (t) {
          !(function e(t, n, i, r) {
            var o = (function (e) {
              ...
              l = s.create(t.uri, a.create(t.positionAt(n.start), t.positionAt(n.end))),
    ...
    function Pt(e, t, n) {
      ...
      return r.endTagStart &&
        ((r.start + '<'.length <= i && i <= r.start + '<'.length + o) ||
          (r.endTagStart + '</'.length <= i && i <= r.endTagStart + '</'.length + o))
        ? [
            a.create(e.positionAt(r.start + '<'.length), e.positionAt(r.start + '<'.length + o)),
            a.create(
        ...
        switch (i) {
          ...
          case fe.StartTagSelfClose:
            ...
            if (d >= 0) {
              var p = o[d];
              (o.length = d),
                (f = e.positionAt(n.getTokenOffset()).line - 1) > (c = p.startLine) &&
                  s !== c &&
          ...
          case fe.Comment:
            ...
            if (m)
              ...
              c < (f = e.positionAt(n.getTokenOffset() + n.getTokenLength()).line) &&
                l({ startLine: c, endLine: f, kind: u.Comment });
        }
        i = n.scan();
      }
            ...
            for (
              ...
              if (n) {
                if (l.startLine > n.startLine)
                  if (l.endLine <= n.endLine) i.push(n), (n = l), a(s, i.length);
        ...
        for (
          var n = (function (e, t) {
              var n = je(e.getText()),
                ...
                o = (function (e) {
                  ...
                  for (; t.parent; )
                    (t = t.parent),
                      ((i = t),
                      i.startTagEnd && i.endTagStart && i.startTagEnd < i.endTagStart
                        ? [
              ...
              if (r.startTagEnd && !r.endTagStart) {
                ...
                var s = a.create(e.positionAt(r.startTagEnd - 2), e.positionAt(r.startTagEnd));
                '/>' === e.getText(s)
              ...
              if ((o.unshift([r.start, r.end]), r.start < i && i < r.startTagEnd)) {
                o.unshift([r.start + 1, r.startTagEnd - 1]);
                l = Bt(e, r, i);
                return (o = l.concat(o));
              }
              return r.startTagEnd <= i && i <= r.endTagStart
                ...
                : (i >= r.endTagStart + 2 && o.unshift([r.endTagStart + 2, r.end - 1]), o);
            })(e, t),
            i = void 0,
            r = void 0,
            o = n.length - 1;
          ...
          var s = n[o];
          (i && s[0] === i[0] && s[1] === i[1]) ||
            (r = le.create(a.create(e.positionAt(n[o][0]), e.positionAt(n[o][1])), r)),
            (i = s);
        }
      ...
      for (
        ...
        switch (l) {
          case fe.AttributeName:
            ...
            o <= s.getTokenEnd() && c.unshift([s.getTokenOffset(), s.getTokenEnd()]),
              (d = !0),
              (u = s.getTokenOffset());
            break;
          case fe.AttributeValue:
    ...
    var jt = {
        ...
        globalAttributes: [
          ...
          { name: 'onpointerdown', description: 'The pointer enters the active buttons state.' },
          {
            name: 'onpointerenter',
          ...
          { name: 'onpointerlockchange', description: 'The pointer was locked or released.' },
          {
            name: 'onpointerlockerror',
            description:
              'It was impossible to lock the pointer for technical reasons or because the permission was denied.',
          },
          { name: 'onpointermove', description: 'The pointer changed coordinates.' },
          {
            name: 'onpointerout',
            description:
          ...
          { name: 'onpointerup', description: 'The pointer leaves the active buttons state.' },
