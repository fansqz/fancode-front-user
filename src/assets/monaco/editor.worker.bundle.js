!(function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e, i) {
      ...
      const C =
        'string' ==
          typeof (null === (r = null == p ? void 0 : p.versions) || void 0 === r
            ? void 0
  ...
  function (e, t, n) {
    ...
    let u = null;
    function h(e) {
      return null == u || u.trackDisposable(e), e;
    }
    function c(e) {
      null == u || u.markAsDisposed(e);
    }
    function d(e, t) {
      null == u || u.setParent(e, t);
    }
    ...
    class C {
      constructor() {
        (this._store = new p()), h(this), d(this._store, this);
      }
      dispose() {
    ...
    class N {
      ...
      initialize(e, t, n, i) {
        ...
        const r = L(i, (e, t) => this._protocol.sendMessage(e, t));
        return this._requestHandlerFactory
          ? ((this._requestHandler = this._requestHandlerFactory(r)),
            Promise.resolve(S(this._requestHandler)))
          : (t &&
    ...
    function x(e, t) {
      t = O(149417, t);
      for (let n = 0, i = e.length; n < i; n++) t = O(e.charCodeAt(n), t);
      return t;
    }
    function M(e, t, n = 32) {
      const i = n - t;
      ...
      _step() {
        ...
        for (let t = 0; t < 80; t++)
          t < 20
            ...
            (r = (M(s, 5) + n + u + i + e.getUint32(4 * t, !1)) & 4294967295),
            (u = l),
            (l = a),
            (a = M(o, 30)),
            (o = s),
    ...
    function U(e, t, n) {
      return new B(new k(e), new k(t)).ComputeDiff(n).changes;
    }
    class D {
      static Assert(e, t) {
    ...
    class B {
      constructor(e, t, n = null) {
        ...
        const [i, r, s] = B._getElements(e),
          [o, a, l] = B._getElements(t);
      ...
      static _getElements(e) {
        ...
        if (B._isStringArray(t)) {
          const e = new Int32Array(t.length);
          for (let n = 0, i = t.length; n < i; n++) e[n] = x(t[n], 0);
          return [t, e, !0];
        }
      ...
      ElementsAreStrictEqual(e, t) {
        ...
        return (
          B._getStrictElement(this._originalSequence, e) ===
          B._getStrictElement(this._modifiedSequence, t)
        );
      }
      ...
      _ComputeDiff(e, t, n, i, r) {
        ...
        return r && (o = this.PrettifyChanges(o)), { quitEarly: s[0], changes: o };
      }
      ComputeDiffRecursive(e, t, n, i, r) {
        ...
        if (e > t || n > i) {
          ...
          return (
            n <= i
              ? (D.Assert(e === t + 1, 'originalStart should only be one more than originalEnd'),
                (r = [new y(e, 0, n, i - n + 1)]))
              : e <= t
              ? (D.Assert(n === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
                (r = [new y(e, t - e + 1, n, 0)]))
              : (D.Assert(e === t + 1, 'originalStart should only be one more than originalEnd'),
                D.Assert(n === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
                (r = [])),
      ...
      WALKTRACE(e, t, n, i, r, s, o, a, l, u, h, c, d, f, m, g, _, p) {
        ...
        do {
          ...
          t === L || (t < E && l[t - 1] < l[t + 1])
            ? ((f = (h = l[t + 1]) - N - i),
              h < v && S.MarkNextChange(),
              (v = h),
              S.AddModifiedElement(h + 1, f),
              (N = t + 1 - e))
            : ((f = (h = l[t - 1] + 1) - N - i),
              h < v && S.MarkNextChange(),
              (v = h - 1),
              S.AddOriginalElement(h, f + 1),
              (N = t - 1 - e)),
            A >= 0 && ((e = (l = this.m_forwardHistory[A])[0]), (L = 1), (E = l.length - 1));
        } while (--A >= -1);
          ...
          do {
            ...
            e === L || (e < E && u[e - 1] >= u[e + 1])
              ? ((f = (h = u[e + 1] - 1) - N - a),
                h > v && S.MarkNextChange(),
                (v = h + 1),
                S.AddOriginalElement(h + 1, f + 1),
                (N = e + 1 - r))
              : ((f = (h = u[e - 1]) - N - a),
                h > v && S.MarkNextChange(),
                (v = h),
                S.AddModifiedElement(h + 1, f + 1),
                (N = e - 1 - r)),
              A >= 0 && ((r = (u = this.m_reverseHistory[A])[0]), (L = 1), (E = u.length - 1));
          } while (--A >= -1);
          b = S.getChanges();
        }
      ...
      ComputeRecursionPoint(e, t, n, i, r, s, o) {
        ...
        for (let E = 1; E <= f / 2 + 1; E++) {
          ...
          for (let e = u; e <= h; e += 2) {
            (a = e === u || (e < h && g[e - 1] < g[e + 1]) ? g[e + 1] : g[e - 1] + 1),
              (l = a - (e - p) - b);
            const n = a;
            ...
            if (
              ((g[e] = a),
              a + l > f + N && ((f = a), (N = l)),
              !L && Math.abs(e - C) <= E - 1 && a >= _[e])
            )
              return (
                (r[0] = a),
                (s[0] = l),
                n <= _[e] && E <= 1448
                  ? this.WALKTRACE(p, u, h, b, C, c, d, S, g, _, a, t, r, l, i, s, L, o)
                  : null
              );
          }
          const v = (f - e + (N - n) - E) / 2;
          ...
          for (let f = c; f <= d; f += 2) {
            (a = f === c || (f < d && _[f - 1] >= _[f + 1]) ? _[f + 1] - 1 : _[f - 1]),
              (l = a - (f - C) - S);
            const m = a;
            for (; a > e && l > n && this.ElementsAreEqual(a, l); ) a--, l--;
            if (((_[f] = a), L && Math.abs(f - p) <= E && a <= g[f]))
              return (
                (r[0] = a),
                (s[0] = l),
                m >= g[f] && E <= 1448
          ...
          if (E <= 1447) {
            ...
            (e[0] = p - u + 1),
              F.Copy2(g, u, e, 1, h - u + 1),
              this.m_forwardHistory.push(e),
              (e = new Int32Array(d - c + 2)),
              (e[0] = C - c + 1),
              F.Copy2(_, c, e, 1, d - c + 1),
              this.m_reverseHistory.push(e);
          }
        }
        return this.WALKTRACE(p, u, h, b, C, c, d, S, g, _, a, t, r, l, i, s, L, o);
      }
      PrettifyChanges(e) {
      ...
      ConcatenateChanges(e, t) {
        ...
        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
          ...
          return (
            F.Copy(e, 0, i, 0, e.length - 1),
            (i[e.length - 1] = n[0]),
            F.Copy(t, 1, i, e.length, t.length - 1),
            i
          );
        }
        {
          const n = new Array(e.length + t.length);
          return F.Copy(e, 0, n, 0, e.length), F.Copy(t, 0, n, e.length, t.length), n;
        }
      }
      ...
      for (let u = 0; u <= e.length; ++u) {
        ...
        if (i(l)) {
          if (o === u - 1 || 1 === a);
            ...
            r.length > 0 ? (r += `${n}${e.slice(o + 1, u)}`) : (r = e.slice(o + 1, u)),
              (s = u - o - 1);
          (o = u), (a = 0);
        } else 46 === l && -1 !== a ? ++a : (a = -1);
      }
    ...
    function z(e, t) {
      if (null === t || 'object' != typeof t) throw new W('pathObject', 'Object', t);
    ...
    const G = {
        resolve(...e) {
          ...
          for (let r = e.length - 1; r >= -1; r--) {
            let s;
            if (r >= 0) {
              if (((s = e[r]), H(s, 'path'), 0 === s.length)) continue;
            } else
              0 === t.length
                ? (s = q.a())
                : ((s = q.b['=' + t] || q.a()),
                  (void 0 === s ||
                    (s.slice(0, 2).toLowerCase() !== t.toLowerCase() && 92 === s.charCodeAt(2))) &&
                    (s = t + '\\'));
            const o = s.length;
            let a = 0,
              l = '',
            ...
            if (1 === o) Y(h) && ((a = 1), (u = !0));
              ...
              if (((u = !0), Y(s.charCodeAt(1)))) {
                let e = 2,
                  t = e;
                for (; e < o && !Y(s.charCodeAt(e)); ) e++;
                if (e < o && e !== t) {
                  const n = s.slice(t, e);
                  for (t = e; e < o && Y(s.charCodeAt(e)); ) e++;
                  if (e < o && e !== t) {
                    for (t = e; e < o && !Y(s.charCodeAt(e)); ) e++;
              ...
              $(h) &&
                58 === s.charCodeAt(1) &&
                ((l = s.slice(0, 2)), (a = 2), o > 2 && Y(s.charCodeAt(2)) && ((u = !0), (a = 3)));
            if (l.length > 0)
              if (t.length > 0) {
        ...
        normalize(e) {
          ...
          if (Y(s))
            if (((r = !0), Y(e.charCodeAt(1)))) {
              let r = 2,
                s = r;
              for (; r < t && !Y(e.charCodeAt(r)); ) r++;
              if (r < t && r !== s) {
                const o = e.slice(s, r);
                for (s = r; r < t && Y(e.charCodeAt(r)); ) r++;
                if (r < t && r !== s) {
                  for (s = r; r < t && !Y(e.charCodeAt(r)); ) r++;
            ...
            $(s) &&
              58 === e.charCodeAt(1) &&
              ((n = e.slice(0, 2)), (i = 2), t > 2 && Y(e.charCodeAt(2)) && ((r = !0), (i = 3)));
          let o = i < t ? j(e.slice(i), !r, '\\', Y) : '';
          return (
            0 !== o.length || r || (o = '.'),
        ...
        isAbsolute(e) {
          ...
          return Y(n) || (t > 2 && $(n) && 58 === e.charCodeAt(1) && Y(e.charCodeAt(2)));
        },
        join(...e) {
          ...
          for (let i = 0; i < e.length; ++i) {
            const r = e[i];
            H(r, 'path'), r.length > 0 && (void 0 === t ? (t = n = r) : (t += '\\' + r));
          }
          if (void 0 === t) return '.';
          let i = !0,
            r = 0;
          if ('string' == typeof n && Y(n.charCodeAt(0))) {
            ++r;
            const e = n.length;
            e > 1 && Y(n.charCodeAt(1)) && (++r, e > 2 && (Y(n.charCodeAt(2)) ? ++r : (i = !1)));
          }
          if (i) {
            for (; r < t.length && Y(t.charCodeAt(r)); ) r++;
            r >= 2 && (t = '\\' + t.slice(r));
          }
          return G.normalize(t);
        },
        relative(e, t) {
          if ((H(e, 'from'), H(t, 'to'), e === t)) return '';
          const n = G.resolve(e),
            i = G.resolve(t);
          if (n === i) return '';
          ...
          if (d !== h) {
            ...
            o > h && (92 === e.charCodeAt(r + d) ? (c = d) : 2 === d && (c = 3)),
              -1 === c && (c = 0);
          }
          let f = '';
          for (d = r + c + 1; d <= s; ++d)
            (d !== s && 92 !== e.charCodeAt(d)) || (f += 0 === f.length ? '..' : '\\..');
          return (
            (a += c),
            f.length > 0 ? `${f}${i.slice(a, l)}` : (92 === i.charCodeAt(a) && ++a, i.slice(a, l))
          );
        },
        toNamespacedPath(e) {
          ...
          } else if ($(t.charCodeAt(0)) && 58 === t.charCodeAt(1) && 92 === t.charCodeAt(2))
            return '\\\\?\\' + t;
          return e;
        },
        dirname(e) {
          ...
          if (Y(r)) {
            ...
            $(r) && 58 === e.charCodeAt(1) && ((n = t > 2 && Y(e.charCodeAt(2)) ? 3 : 2), (i = n));
          let s = -1,
            o = !0;
          for (let n = t - 1; n >= i; --n)
            if (Y(e.charCodeAt(n))) {
        ...
        basename(e, t) {
          ...
          let n,
            ...
            s = !0;
          if (
            (e.length >= 2 && $(e.charCodeAt(0)) && 58 === e.charCodeAt(1) && (i = 2),
            ...
            for (n = e.length - 1; n >= i; --n) {
              ...
              if (Y(l)) {
                ...
                -1 === a && ((s = !1), (a = n + 1)),
                  o >= 0 && (l === t.charCodeAt(o) ? -1 == --o && (r = n) : ((o = -1), (r = a)));
            }
        ...
        extname(e) {
          ...
          let t = 0,
            ...
            s = !0,
            o = 0;
          e.length >= 2 && 58 === e.charCodeAt(1) && $(e.charCodeAt(0)) && (t = i = 2);
          for (let a = e.length - 1; a >= t; --a) {
            ...
            if (Y(t)) {
              ...
              -1 === r && ((s = !1), (r = a + 1)),
                46 === t ? (-1 === n ? (n = a) : 1 !== o && (o = 1)) : -1 !== n && (o = -1);
          }
          return -1 === n || -1 === r || 0 === o || (1 === o && n === r - 1 && n === i + 1)
            ? ''
            : e.slice(n, r);
        },
        format: z.bind(null, '\\'),
        parse(e) {
          ...
          let i = 0,
            r = e.charCodeAt(0);
          if (1 === n) return Y(r) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
          if (Y(r)) {
            if (((i = 1), Y(e.charCodeAt(1)))) {
              let t = 2,
                r = t;
              for (; t < n && !Y(e.charCodeAt(t)); ) t++;
              if (t < n && t !== r) {
                for (r = t; t < n && Y(e.charCodeAt(t)); ) t++;
                if (t < n && t !== r) {
                  for (r = t; t < n && !Y(e.charCodeAt(t)); ) t++;
                  t === n ? (i = t) : t !== r && (i = t + 1);
                }
      ...
      Q = {
        resolve(...e) {
          ...
          for (let i = e.length - 1; i >= -1 && !n; i--) {
            const r = i >= 0 ? e[i] : q.a();
            H(r, 'path'), 0 !== r.length && ((t = `${r}/${t}`), (n = 47 === r.charCodeAt(0)));
          }
          return (t = j(t, !n, '/', V)), n ? '/' + t : t.length > 0 ? t : '.';
        },
        normalize(e) {
          if ((H(e, 'path'), 0 === e.length)) return '.';
          const t = 47 === e.charCodeAt(0),
            n = 47 === e.charCodeAt(e.length - 1);
          return 0 === (e = j(e, !t, '/', V)).length
            ? t
              ? '/'
              : n
              ? './'
        ...
        isAbsolute: (e) => (H(e, 'path'), e.length > 0 && 47 === e.charCodeAt(0)),
        join(...e) {
          if (0 === e.length) return '.';
          let t;
          for (let n = 0; n < e.length; ++n) {
            const i = e[n];
            H(i, 'path'), i.length > 0 && (void 0 === t ? (t = i) : (t += '/' + i));
          }
          return void 0 === t ? '.' : Q.normalize(t);
        },
        relative(e, t) {
          if ((H(e, 'from'), H(t, 'to'), e === t)) return '';
          if ((e = Q.resolve(e)) === (t = Q.resolve(t))) return '';
          const n = e.length,
            i = n - 1,
            r = t.length - 1,
            s = i < r ? i : r;
          ...
          if (a === s)
            ...
            } else i > s && (47 === e.charCodeAt(1 + a) ? (o = a) : 0 === a && (o = 0));
          let l = '';
          for (a = 1 + o + 1; a <= n; ++a)
            (a !== n && 47 !== e.charCodeAt(a)) || (l += 0 === l.length ? '..' : '/..');
    ...
    (Q.win32 = G.win32 = G), (Q.posix = G.posix = Q);
    'win32' === q.c ? G.normalize : Q.normalize,
      'win32' === q.c ? G.resolve : Q.resolve,
      'win32' === q.c ? G.relative : Q.relative,
      'win32' === q.c ? G.dirname : Q.dirname,
      'win32' === q.c ? G.basename : Q.basename,
      'win32' === q.c ? G.extname : Q.extname,
      'win32' === q.c ? G.sep : Q.sep;
    const X = /^\w[\w\d+.-]*$/,
      Z = /^\//,
      J = /^\/\//;
    function ee(e, t) {
    ...
    class ie {
      ...
      static parse(e, t = !1) {
        const n = ne.exec(e);
        return n
          ? new se(n[2] || '', de(n[4] || ''), de(n[5] || ''), de(n[7] || ''), de(n[9] || ''), t)
          : new se('', '', '', '', '');
      }
      static file(e) {
        let t = '';
    ...
    const re = b.d ? 1 : void 0;
    class se extends ie {
      constructor() {
        super(...arguments), (this._formatted = null), (this._fsPath = null);
      }
      get fsPath() {
        return this._fsPath || (this._fsPath = ue(this, !1)), this._fsPath;
      }
      toString(e = !1) {
        return e
          ? he(this, !0)
          : (this._formatted || (this._formatted = he(this, !1)), this._formatted);
      }
      toJSON() {
        const e = { $mid: 1 };
        return (
    ...
    function le(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        35 === i || 63 === i
          ? (void 0 === t && (t = e.substr(0, n)), (t += oe[i]))
          : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
    ...
    function he(e, t) {
      ...
      if ((r && ((i += r), (i += ':')), (s || 'file' === r) && ((i += te), (i += te)), s)) {
        let e = s.indexOf('@');
        if (-1 !== e) {
        ...
        (s = s.toLowerCase()),
          (e = s.indexOf(':')),
          -1 === e ? (i += n(s, !1)) : ((i += n(s.substr(0, e), !1)), (i += s.substr(e)));
      }
      if (o) {
      ...
      return a && ((i += '?'), (i += n(a, !1))), l && ((i += '#'), (i += t ? l : ae(l, !1))), i;
    }
    const ce = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function de(e) {
      return e.match(ce)
        ? e.replace(ce, (e) =>
            (function e(t) {
    ...
    class fe {
      ...
      with(e = this.lineNumber, t = this.column) {
        return e === this.lineNumber && t === this.column ? this : new fe(e, t);
      }
      delta(e = 0, t = 0) {
      ...
      isBeforeOrEqual(e) {
        return fe.isBeforeOrEqual(this, e);
      }
      ...
      static lift(e) {
        return new fe(e.lineNumber, e.column);
      }
    ...
    class me {
      ...
      static intersectRanges(e, t) {
        ...
        return (
          ...
          n > r || (n === r && i > s) ? null : new me(n, i, r, s)
        );
      }
      equalsRange(e) {
    ...
    function ge(e, t, n, i) {
      return new B(e, t, n).ComputeDiff(i);
    }
    class _e {
      constructor(e) {
        const t = [],
          n = [];
        for (let i = 0, r = e.length; i < r; i++) (t[i] = Le(e[i], 1)), (n[i] = Ee(e[i], 1));
      ...
      static createFromDiffResult(e, t, n, i, r, s, o) {
        ...
        if (
          ...
          o &&
            ...
            (c = []);
          for (let e = 0, t = l.length; e < t; e++) c.push(Ce.createFromDiffChange(l[e], s, a));
        }
        return new be(a, l, u, h, c);
      }
    }
    class Se {
      constructor(e, t, n) {
        (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
          ...
          (this.original = new _e(e)),
          (this.modified = new _e(t)),
          (this.continueLineDiff = Ne(n.maxComputationTime)),
          (this.continueCharDiff = Ne(
      ...
      _pushTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
        ...
        let a = void 0;
        this.shouldComputeCharChanges && (a = [new Ce(t, n, t, i, r, s, r, o)]),
          e.push(new be(t, t, r, r, a));
      }
      _mergeTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
        ...
        return (
          ...
          this.shouldComputeCharChanges &&
            l.charChanges &&
            l.charChanges.push(new Ce(t, n, t, i, r, s, r, o)),
          !0)
        );
      }
    }
    ...
    class we {
      ...
      getIndexOf(e) {
        ...
        for (; t <= n; )
          if (
            ((i = (t + (n - t) / 2) | 0), (r = this.prefixSum[i]), (s = r - this.values[i]), e < s)
          )
            n = i - 1;
          else {
            if (!(e >= r)) break;
    ...
    const Oe = { maxLen: 1e3, windowSize: 15, timeBudget: 150 };
    function xe(e, t, n, i) {
      let r;
      for (; (r = e.exec(t)); ) {
        const t = r.index || 0;
    ...
    class Me {
      constructor(e) {
        let t = ye(e);
        (this._defaultValue = t), (this._asciiMap = Me._createAsciiMap(t)), (this._map = new Map());
      }
    ...
    class Ue {
      static _createLink(e, t, n, i, r) {
        ...
        return {
          range: { startLineNumber: n, startColumn: i + 1, endLineNumber: n, endColumn: s + 2 },
      ...
      static computeLinks(
        ...
        const n = (function () {
          if (null === ke) {
            ke = new Me(0);
            const e = ' \t<>\'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…';
            for (let t = 0; t < e.length; t++) ke.set(e.charCodeAt(t), 1);
            const t = '.,;';
            for (let e = 0; e < t.length; e++) ke.set(t.charCodeAt(e), 2);
          }
          return ke;
        })();
        let i = [];
        for (let r = 1, s = e.getLineCount(); r <= s; r++) {
          ...
          for (; a < o; ) {
            ...
            if (13 === h) {
              ...
              1 === t && (i.push(Ue._createLink(n, s, r, l, a)), (e = !0));
            } else if (12 === h) {
              let t;
              91 === o ? ((d = !0), (t = 0)) : (t = n.get(o)), 1 === t ? (e = !0) : (h = 13);
            } else (h = t.nextState(h, o)), 0 === h && (e = !0);
            e && ((h = 1), (c = !1), (d = !1), (m = !1), (l = a + 1), (u = o)), a++;
          }
          13 === h && i.push(Ue._createLink(n, s, r, l, o));
        }
        return i;
      }
    }
    ...
    class Fe {
      constructor(e) {
        (this.element = e), (this.next = Fe.Undefined), (this.prev = Fe.Undefined);
      }
    }
    ...
    class Ke {
      ...
      clear() {
        ...
        for (; e !== Fe.Undefined; ) {
          const t = e.next;
          (e.prev = Fe.Undefined), (e.next = Fe.Undefined), (e = t);
        }
        (this._first = Fe.Undefined), (this._last = Fe.Undefined), (this._size = 0);
      }
      unshift(e) {
      ...
      _insert(e, t) {
        const n = new Fe(e);
        if (this._first === Fe.Undefined) (this._first = n), (this._last = n);
        else if (t) {
          const e = this._last;
      ...
      _remove(e) {
        if (e.prev !== Fe.Undefined && e.next !== Fe.Undefined) {
          ...
          e.prev === Fe.Undefined && e.next === Fe.Undefined
            ...
            : e.next === Fe.Undefined
            ? ((this._last = this._last.prev), (this._last.next = Fe.Undefined))
            : e.prev === Fe.Undefined &&
              ((this._first = this._first.next), (this._first.prev = Fe.Undefined));
        this._size -= 1;
      }
      *[Symbol.iterator]() {
        let e = this._first;
        for (; e !== Fe.Undefined; ) yield e.element, (e = e.next);
      }
    }
    const Be = b.a.performance && 'function' == typeof b.a.performance.now;
    class qe {
      constructor(e) {
        (this._highResolution = Be && e), (this._startTime = this._now()), (this._stopTime = -1);
      }
      static create(e = !0) {
        return new qe(e);
      }
      ...
      constructor(e) {
        ...
        (this._disposed = !1),
          ...
          (this._perfMon = (null === (t = this._options) || void 0 === t ? void 0 : t._profName)
            ? new He(this._options._profName)
            : void 0);
      }
      get event() {
        return (
          this._event ||
            (this._event = (e, t, n) => {
              var i;
              this._listeners || (this._listeners = new Ke());
              ...
              const o =
                ...
                a = _(() => {
                  if (
                    (o && o(),
                    !this._disposed && (s(), this._options && this._options.onLastListenerRemove))
                  ) {
                    (this._listeners && !this._listeners.isEmpty()) ||
                      this._options.onLastListenerRemove(this);
                  }
                });
              return n instanceof p ? n.add(a) : Array.isArray(n) && n.push(a), a;
            }),
          this._event
        );
      }
    ...
    const Ve = Object.freeze(function (e, t) {
    ...
    var $e, je;
    ((je = $e || ($e = {})).isCancellationToken = function (e) {
      return (
        e === je.None ||
        e === je.Cancelled ||
        e instanceof ze ||
      ...
      (je.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: We.None })),
      (je.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: Ve }));
    class ze {
      constructor() {
      ...
      get onCancellationRequested() {
        return this._isCancelled
          ? Ve
          : (this._emitter || (this._emitter = new Ye()), this._emitter.event);
      }
      dispose() {
    ...
    !(function () {
      function e(e, t, n = t, i = n) {
        Xe.define(e, t), Ze.define(e, n), Je.define(e, i);
      }
      e(0, 'unknown'),
        e(1, 'Backspace'),
        e(2, 'Tab'),
      ...
      (function (e) {
        (e.toString = function (e) {
          ...
          (e.fromUserSettings = function (e) {
            return Ze.strToKeyCode(e) || Je.strToKeyCode(e);
          });
      })(et || (et = {}));
    class Ut extends me {
      constructor(e, t, n, i) {
    ...
    class Bt extends class {
      ...
      onEvents(e) {
        ...
        for (const e of t)
          this._acceptDeleteRange(e.range),
            this._acceptInsertText(new fe(e.range.startLineNumber, e.range.startColumn), e.text);
      ...
      getWordAtPosition(e, t) {
        let n = (function e(t, n, i, r, s = Oe) {
          if (i.length > s.maxLen) {
            let o = t - s.maxLen / 2;
            return (
              o < 0 ? (o = 0) : (r += o), e(t, n, (i = i.substring(o, t + s.maxLen / 2)), r, s)
            );
          }
          const o = Date.now(),
            a = t - 1 - r;
    ...
    class qt {
      ...
      acceptNewModel(e) {
        this._models[e.url] = new Bt(ie.parse(e.url), e.lines, e.EOL, e.versionId);
      }
      ...
      computeMoreMinimalEdits(e, t) {
        return Kt(this, void 0, void 0, function* () {
          ...
          for (let { range: e, text: s, eol: o } of t) {
            if (('number' == typeof o && (r = o), me.isEmpty(e) && !s)) continue;
            const t = n.getValueInRange(e);
            if (((s = s.replace(/\r\n|\n|\r/g, n.eol)), t === s)) continue;
            if (Math.max(s.length, t.length) > qt._diffLimit) {
          ...
          e: for (let n of e) {
            ...
            if (e)
              for (let n of e.words(s))
                if (n !== t && isNaN(Number(n)) && (o.add(n), o.size > qt._suggestionsLimit))
                  break e;
          }
      ...
      navigateValueSet(e, t, n, i, r) {
        return Kt(this, void 0, void 0, function* () {
          ...
          let a = s.getValueInRange(t),
            l = s.getWordAtPosition({ lineNumber: t.startLineNumber, column: t.startColumn }, o);
          if (!l) return null;
