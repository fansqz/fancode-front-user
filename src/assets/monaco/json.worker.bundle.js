!(function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e, r) {
      ...
      const y =
        'string' ==
          typeof (null === (i = null == v ? void 0 : v.versions) || void 0 === i
            ? void 0
  ...
  function (e, t, n) {
    ...
    let l = null;
    function c(e) {
      return null == l || l.trackDisposable(e), e;
    }
    function h(e) {
      null == l || l.markAsDisposed(e);
    }
    function f(e, t) {
      null == l || l.setParent(e, t);
    }
    ...
    class y {
      constructor() {
        (this._store = new v()), c(this), f(this._store, this);
      }
      dispose() {
    ...
    class S {
      ...
      handleMessage(e) {
        e &&
          e.vsWorker &&
          ((-1 !== this._workerId && e.vsWorker !== this._workerId) || this._handleMessage(e));
      }
      _handleMessage(e) {
        if (e.seq) {
          let t = e;
    ...
    class A {
      ...
      initialize(e, t, n, r) {
        ...
        const i = C(r, (e, t) => this._protocol.sendMessage(e, t));
        return this._requestHandlerFactory
          ? ((this._requestHandler = this._requestHandlerFactory(i)),
            Promise.resolve(_(this._requestHandler)))
          : (t &&
    ...
    function k(e, t) {
      t = T(149417, t);
      for (let n = 0, r = e.length; n < r; n++) t = T(e.charCodeAt(n), t);
      return t;
    }
    function O(e, t, n = 32) {
      const r = n - t;
    ...
    function I(e, t = 0, n = e.byteLength, r = 0) {
      ...
      digest() {
        return (
          this._finished ||
            ...
            this._wrapUp()),
          P(this._h0) + P(this._h1) + P(this._h2) + P(this._h3) + P(this._h4)
        );
      }
      _wrapUp() {
        (this._buff[this._buffLen++] = 128),
          I(this._buff, this._buffLen),
          this._buffLen > 56 && (this._step(), I(this._buff));
      ...
      _step() {
        ...
        for (let t = 0; t < 80; t++)
          t < 20
            ...
            (i = (O(o, 5) + n + l + r + e.getUint32(4 * t, !1)) & 4294967295),
            (l = u),
            (u = a),
            (a = O(s, 30)),
            (s = o),
    ...
    function D(e, t, n) {
      return new V(new R(e), new R(t)).ComputeDiff(n).changes;
    }
    class F {
      static Assert(e, t) {
    ...
    class V {
      constructor(e, t, n = null) {
        ...
        const [r, i, o] = V._getElements(e),
          [s, a, u] = V._getElements(t);
      ...
      static _getElements(e) {
        ...
        if (V._isStringArray(t)) {
          const e = new Int32Array(t.length);
          for (let n = 0, r = t.length; n < r; n++) e[n] = k(t[n], 0);
          return [t, e, !0];
        }
      ...
      ElementsAreStrictEqual(e, t) {
        ...
        return (
          V._getStrictElement(this._originalSequence, e) ===
          V._getStrictElement(this._modifiedSequence, t)
        );
      }
      ...
      ComputeDiffRecursive(e, t, n, r, i) {
        ...
        if (e > t || n > r) {
          ...
          return (
            n <= r
              ? (F.Assert(e === t + 1, 'originalStart should only be one more than originalEnd'),
                (i = [new E(e, 0, n, r - n + 1)]))
              : e <= t
              ? (F.Assert(n === r + 1, 'modifiedStart should only be one more than modifiedEnd'),
                (i = [new E(e, t - e + 1, n, 0)]))
              : (F.Assert(e === t + 1, 'originalStart should only be one more than originalEnd'),
                F.Assert(n === r + 1, 'modifiedStart should only be one more than modifiedEnd'),
                (i = [])),
      ...
      WALKTRACE(e, t, n, r, i, o, s, a, u, l, c, h, f, d, m, g, p, v) {
        ...
        do {
          ...
          t === C || (t < S && u[t - 1] < u[t + 1])
            ...
            : ((d = (c = u[t - 1] + 1) - A - r),
              ...
              (A = t - 1 - e)),
            w >= 0 && ((e = (u = this.m_forwardHistory[w])[0]), (C = 1), (S = u.length - 1));
        } while (--w >= -1);
        if (((y = _.getReverseChanges()), v[0])) {
          ...
          (_ = new U()),
            ...
            (A = f[0] - g[0] - a),
            (x = 1073741824),
            (w = p ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2);
          do {
            const e = A + i;
            e === C || (e < S && l[e - 1] >= l[e + 1])
              ? ((d = (c = l[e + 1] - 1) - A - a),
              ...
              : ((d = (c = l[e - 1]) - A - a),
                ...
                (A = e - 1 - i)),
              w >= 0 && ((i = (l = this.m_reverseHistory[w])[0]), (C = 1), (S = l.length - 1));
          } while (--w >= -1);
          b = _.getChanges();
        }
      ...
      ComputeRecursionPoint(e, t, n, r, i, o, s) {
        ...
        for (let S = 1; S <= d / 2 + 1; S++) {
          ...
          for (let e = l; e <= c; e += 2) {
            (a = e === l || (e < c && g[e - 1] < g[e + 1]) ? g[e + 1] : g[e - 1] + 1),
              (u = a - (e - v) - b);
            const n = a;
          ...
          const x = (d - e + (A - n) - S) / 2;
          if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(d, x))
            return (
              (s[0] = !0),
              (i[0] = d),
              (o[0] = A),
      ...
      PrettifyChanges(e) {
        for (let t = 0; t < e.length; t++) {
          ...
          for (
            ...
            (!o ||
              this.OriginalElementsAreEqual(n.originalStart, n.originalStart + n.originalLength)) &&
            (!s ||
      ...
      ConcatenateChanges(e, t) {
        ...
        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
          ...
          return (
            j.Copy(e, 0, r, 0, e.length - 1),
            (r[e.length - 1] = n[0]),
            j.Copy(t, 1, r, e.length, t.length - 1),
            r
          );
        }
        {
          const n = new Array(e.length + t.length);
          return j.Copy(e, 0, n, 0, e.length), j.Copy(t, 0, n, e.length, t.length), n;
        }
      }
    ...
    function W(e, t) {
      if ('string' != typeof e) throw new q(t, 'string', e);
    }
    function B(e) {
      return 47 === e || 92 === e;
    }
      ...
      for (let l = 0; l <= e.length; ++l) {
        ...
        if (r(u)) {
          if (s === l - 1 || 1 === a);
            ...
            i.length > 0 ? (i += `${n}${e.slice(s + 1, l)}`) : (i = e.slice(s + 1, l)),
              (o = l - s - 1);
          (s = l), (a = 0);
        } else 46 === u && -1 !== a ? ++a : (a = -1);
      }
    ...
    function z(e, t) {
      if (null === t || 'object' != typeof t) throw new q('pathObject', 'Object', t);
    ...
    const G = {
        resolve(...e) {
          ...
          for (let i = e.length - 1; i >= -1; i--) {
            let o;
            if (i >= 0) {
              if (((o = e[i]), W(o, 'path'), 0 === o.length)) continue;
            } else
              0 === t.length
                ? (o = $.a())
                : ((o = $.b['=' + t] || $.a()),
                  (void 0 === o ||
                    (o.slice(0, 2).toLowerCase() !== t.toLowerCase() && 92 === o.charCodeAt(2))) &&
                    (o = t + '\\'));
            const s = o.length;
            let a = 0,
              u = '',
            ...
            if (1 === s) B(c) && ((a = 1), (l = !0));
              ...
              if (((l = !0), B(o.charCodeAt(1)))) {
                let e = 2,
                  t = e;
                for (; e < s && !B(o.charCodeAt(e)); ) e++;
                if (e < s && e !== t) {
                  const n = o.slice(t, e);
                  for (t = e; e < s && B(o.charCodeAt(e)); ) e++;
                  if (e < s && e !== t) {
                    for (t = e; e < s && !B(o.charCodeAt(e)); ) e++;
              ...
              H(c) &&
                58 === o.charCodeAt(1) &&
                ((u = o.slice(0, 2)), (a = 2), s > 2 && B(o.charCodeAt(2)) && ((l = !0), (a = 3)));
            if (u.length > 0)
              if (t.length > 0) {
        ...
        normalize(e) {
          ...
          if (B(o))
            if (((i = !0), B(e.charCodeAt(1)))) {
              let i = 2,
                o = i;
              for (; i < t && !B(e.charCodeAt(i)); ) i++;
              if (i < t && i !== o) {
                const s = e.slice(o, i);
                for (o = i; i < t && B(e.charCodeAt(i)); ) i++;
                if (i < t && i !== o) {
                  for (o = i; i < t && !B(e.charCodeAt(i)); ) i++;
            ...
            H(o) &&
              58 === e.charCodeAt(1) &&
              ((n = e.slice(0, 2)), (r = 2), t > 2 && B(e.charCodeAt(2)) && ((i = !0), (r = 3)));
          let s = r < t ? Y(e.slice(r), !i, '\\', B) : '';
          return (
            0 !== s.length || i || (s = '.'),
            s.length > 0 && B(e.charCodeAt(t - 1)) && (s += '\\'),
        ...
        isAbsolute(e) {
          ...
          return B(n) || (t > 2 && H(n) && 58 === e.charCodeAt(1) && B(e.charCodeAt(2)));
        },
        join(...e) {
          ...
          for (let r = 0; r < e.length; ++r) {
            const i = e[r];
            W(i, 'path'), i.length > 0 && (void 0 === t ? (t = n = i) : (t += '\\' + i));
          }
          if (void 0 === t) return '.';
          let r = !0,
            i = 0;
          if ('string' == typeof n && B(n.charCodeAt(0))) {
            ++i;
            const e = n.length;
            e > 1 && B(n.charCodeAt(1)) && (++i, e > 2 && (B(n.charCodeAt(2)) ? ++i : (r = !1)));
          }
          if (r) {
        ...
        relative(e, t) {
          ...
          if (f !== c) {
            ...
            s > c && (92 === e.charCodeAt(i + f) ? (h = f) : 2 === f && (h = 3)),
              -1 === h && (h = 0);
          }
          let d = '';
          for (f = i + h + 1; f <= o; ++f)
            (f !== o && 92 !== e.charCodeAt(f)) || (d += 0 === d.length ? '..' : '\\..');
          return (
            (a += h),
            d.length > 0 ? `${d}${r.slice(a, u)}` : (92 === r.charCodeAt(a) && ++a, r.slice(a, u))
          );
        },
        toNamespacedPath(e) {
          ...
          } else if (H(t.charCodeAt(0)) && 58 === t.charCodeAt(1) && 92 === t.charCodeAt(2))
            return '\\\\?\\' + t;
          return e;
        },
        dirname(e) {
          ...
          if (B(i)) {
            ...
            H(i) && 58 === e.charCodeAt(1) && ((n = t > 2 && B(e.charCodeAt(2)) ? 3 : 2), (r = n));
          let o = -1,
            s = !0;
          for (let n = t - 1; n >= r; --n)
            if (B(e.charCodeAt(n))) {
        ...
        basename(e, t) {
          ...
          let n,
            ...
            o = !0;
          if (
            (e.length >= 2 && H(e.charCodeAt(0)) && 58 === e.charCodeAt(1) && (r = 2),
        ...
        extname(e) {
          ...
          let t = 0,
            ...
            o = !0,
            s = 0;
          e.length >= 2 && 58 === e.charCodeAt(1) && H(e.charCodeAt(0)) && (t = r = 2);
          for (let a = e.length - 1; a >= t; --a) {
            ...
            if (B(t)) {
              ...
              -1 === i && ((o = !1), (i = a + 1)),
                46 === t ? (-1 === n ? (n = a) : 1 !== s && (s = 1)) : -1 !== n && (s = -1);
          }
          return -1 === n || -1 === i || 0 === s || (1 === s && n === i - 1 && n === r + 1)
            ? ''
            : e.slice(n, i);
        },
        format: z.bind(null, '\\'),
        parse(e) {
          ...
          let r = 0,
            i = e.charCodeAt(0);
          if (1 === n) return B(i) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
          if (B(i)) {
            if (((r = 1), B(e.charCodeAt(1)))) {
              let t = 2,
                i = t;
              for (; t < n && !B(e.charCodeAt(t)); ) t++;
              if (t < n && t !== i) {
                for (i = t; t < n && B(e.charCodeAt(t)); ) t++;
                if (t < n && t !== i) {
                  for (i = t; t < n && !B(e.charCodeAt(t)); ) t++;
                  t === n ? (r = t) : t !== i && (r = t + 1);
                }
      ...
      J = {
        resolve(...e) {
          ...
          for (let r = e.length - 1; r >= -1 && !n; r--) {
            const i = r >= 0 ? e[r] : $.a();
            W(i, 'path'), 0 !== i.length && ((t = `${i}/${t}`), (n = 47 === i.charCodeAt(0)));
          }
          return (t = Y(t, !n, '/', K)), n ? '/' + t : t.length > 0 ? t : '.';
        },
        normalize(e) {
          if ((W(e, 'path'), 0 === e.length)) return '.';
          const t = 47 === e.charCodeAt(0),
            n = 47 === e.charCodeAt(e.length - 1);
          return 0 === (e = Y(e, !t, '/', K)).length
            ? t
              ? '/'
              : n
              ? './'
        ...
        join(...e) {
          ...
          for (let n = 0; n < e.length; ++n) {
            const r = e[n];
            W(r, 'path'), r.length > 0 && (void 0 === t ? (t = r) : (t += '/' + r));
          }
        ...
        relative(e, t) {
          ...
          let u = '';
          for (a = 1 + s + 1; a <= n; ++a)
            (a !== n && 47 !== e.charCodeAt(a)) || (u += 0 === u.length ? '..' : '/..');
    ...
    (J.win32 = G.win32 = G), (J.posix = G.posix = J);
    'win32' === $.c ? G.normalize : J.normalize,
      'win32' === $.c ? G.resolve : J.resolve,
      'win32' === $.c ? G.relative : J.relative,
      'win32' === $.c ? G.dirname : J.dirname,
      'win32' === $.c ? G.basename : J.basename,
      'win32' === $.c ? G.extname : J.extname,
      'win32' === $.c ? G.sep : J.sep;
    const Q = /^\w[\w\d+.-]*$/,
      X = /^\//,
      Z = /^\/\//;
    ...
    class re {
      ...
      static parse(e, t = !1) {
        const n = ne.exec(e);
        return n
          ? new oe(n[2] || '', fe(n[4] || ''), fe(n[5] || ''), fe(n[7] || ''), fe(n[9] || ''), t)
          : new oe('', '', '', '', '');
      }
      static file(e) {
        let t = '';
        if ((b.d && (e = e.replace(/\\/g, te)), e[0] === te && e[1] === te)) {
          const n = e.indexOf(te, 2);
          -1 === n
            ? ((t = e.substring(2)), (e = te))
            : ((t = e.substring(2, n)), (e = e.substring(n) || te));
        }
        return new oe('file', t, e, '', '');
      }
      static from(e) {
        const t = new oe(e.scheme, e.authority, e.path, e.query, e.fragment);
        return ee(t, !0), t;
      }
      static joinPath(e, ...t) {
      ...
      static revive(e) {
        if (e) {
          ...
          {
            const t = new oe(e);
            return (t._formatted = e.external), (t._fsPath = e._sep === ie ? e.fsPath : null), t;
          }
        }
        return e;
      }
    }
    const ie = b.d ? 1 : void 0;
    class oe extends re {
      constructor() {
        super(...arguments), (this._formatted = null), (this._fsPath = null);
      }
      get fsPath() {
        return this._fsPath || (this._fsPath = le(this, !1)), this._fsPath;
      }
      toString(e = !1) {
        return e
          ? ce(this, !0)
          : (this._formatted || (this._formatted = ce(this, !1)), this._formatted);
      }
      toJSON() {
        const e = { $mid: 1 };
        return (
    ...
    function ue(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        35 === r || 63 === r
          ? (void 0 === t && (t = e.substr(0, n)), (t += se[r]))
          : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
    ...
    function ce(e, t) {
      ...
      if ((i && ((r += i), (r += ':')), (o || 'file' === i) && ((r += te), (r += te)), o)) {
        let e = o.indexOf('@');
        if (-1 !== e) {
          ...
          (o = o.substr(e + 1)),
            ...
            -1 === e
              ? (r += n(t, !1))
              : ((r += n(t.substr(0, e), !1)), (r += ':'), (r += n(t.substr(e + 1), !1))),
            (r += '@');
        }
        (o = o.toLowerCase()),
          (e = o.indexOf(':')),
      ...
      return a && ((r += '?'), (r += n(a, !1))), u && ((r += '#'), (r += t ? u : ae(u, !1))), r;
    }
    const he = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function fe(e) {
      return e.match(he)
        ? e.replace(he, (e) =>
            (function e(t) {
    ...
    class de {
      ...
      with(e = this.lineNumber, t = this.column) {
        return e === this.lineNumber && t === this.column ? this : new de(e, t);
      }
      delta(e = 0, t = 0) {
    ...
    class me {
      ...
      containsPosition(e) {
        return me.containsPosition(this, e);
      }
      ...
      containsRange(e) {
        return me.containsRange(this, e);
      }
      ...
      strictContainsRange(e) {
        return me.strictContainsRange(this, e);
      }
      ...
      intersectRanges(e) {
        return me.intersectRanges(this, e);
      }
      static intersectRanges(e, t) {
        ...
        return (
          ...
          n > i || (n === i && r > o) ? null : new me(n, r, i, o)
        );
      }
      equalsRange(e) {
        return me.equalsRange(this, e);
      }
      ...
      setEndPosition(e, t) {
        return new me(this.startLineNumber, this.startColumn, e, t);
      }
      setStartPosition(e, t) {
        return new me(e, t, this.endLineNumber, this.endColumn);
      }
      collapseToStart() {
        return me.collapseToStart(this);
      }
      static collapseToStart(e) {
        return new me(e.startLineNumber, e.startColumn, e.startLineNumber, e.startColumn);
      }
      static fromPositions(e, t = e) {
        return new me(e.lineNumber, e.column, t.lineNumber, t.column);
      }
      static lift(e) {
        return e ? new me(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn) : null;
      }
      static isIRange(e) {
        return (
          e &&
    ...
    function ge(e, t, n, r) {
      return new V(e, t, n).ComputeDiff(r);
    }
    class pe {
      constructor(e) {
        const t = [],
          n = [];
        for (let r = 0, i = e.length; r < i; r++) (t[r] = Ce(e[r], 1)), (n[r] = Se(e[r], 1));
      ...
      static createFromDiffResult(e, t, n, r, i, o, s) {
        ...
        if (
          ...
          s &&
            ...
            (h = []);
          for (let e = 0, t = u.length; e < t; e++) h.push(ye.createFromDiffChange(u[e], o, a));
        }
        return new be(a, u, l, c, h);
      }
    }
    class _e {
      constructor(e, t, n) {
        (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
          ...
          (this.continueLineDiff = Ae(n.maxComputationTime)),
          (this.continueCharDiff = Ae(
      ...
      _pushTrimWhitespaceCharChange(e, t, n, r, i, o, s) {
        ...
        let a = void 0;
        this.shouldComputeCharChanges && (a = [new ye(t, n, t, r, i, o, i, s)]),
          e.push(new be(t, t, i, i, a));
      }
      _mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s) {
        ...
        return (
          ...
          this.shouldComputeCharChanges &&
            u.charChanges &&
            u.charChanges.push(new ye(t, n, t, r, i, o, i, s)),
          !0)
        );
      }
    }
    ...
    class Ne {
      ...
      getPrefixSum(e) {
        return e < 0 ? 0 : ((e = xe(e)), this._getPrefixSum(e));
      }
      _getPrefixSum(e) {
      ...
      getIndexOf(e) {
        ...
        for (; t <= n; )
          if (
            ((r = (t + (n - t) / 2) | 0), (i = this.prefixSum[r]), (o = i - this.values[r]), e < o)
          )
            n = r - 1;
          else {
            if (!(e >= i)) break;
    ...
    const Te = { maxLen: 1e3, windowSize: 15, timeBudget: 150 };
    function ke(e, t, n, r) {
      let i;
      for (; (i = e.exec(t)); ) {
        const t = i.index || 0;
    ...
    class Oe {
      constructor(e) {
        let t = Ee(e);
        (this._defaultValue = t), (this._asciiMap = Oe._createAsciiMap(t)), (this._map = new Map());
      }
      ...
      static computeLinks(
        ...
        const n = (function () {
          if (null === Re) {
            Re = new Oe(0);
            const e = ' \t<>\'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…';
            for (let t = 0; t < e.length; t++) Re.set(e.charCodeAt(t), 1);
            const t = '.,;';
            for (let e = 0; e < t.length; e++) Re.set(t.charCodeAt(e), 2);
          }
          return Re;
        })();
        let r = [];
        for (let i = 1, o = e.getLineCount(); i <= o; i++) {
          ...
          for (; a < s; ) {
            ...
            if (13 === c) {
              ...
              1 === t && (r.push(De._createLink(n, o, i, u, a)), (e = !0));
            } else if (12 === c) {
              let t;
          ...
          13 === c && r.push(De._createLink(n, o, i, u, s));
        }
        return r;
      }
    }
    class Fe {
      ...
      valueSetReplace(e, t, n) {
        let r = e.indexOf(t);
        return r >= 0
          ? ((r += n ? 1 : -1), r < 0 ? (r = e.length - 1) : (r %= e.length), e[r])
          : null;
      }
    }
    Fe.INSTANCE = new Fe();
    ...
    class Ue {
      constructor() {
        (this._first = je.Undefined), (this._last = je.Undefined), (this._size = 0);
      }
      get size() {
        return this._size;
      }
      isEmpty() {
        return this._first === je.Undefined;
      }
      clear() {
        let e = this._first;
        for (; e !== je.Undefined; ) {
          const t = e.next;
          (e.prev = je.Undefined), (e.next = je.Undefined), (e = t);
        }
        (this._first = je.Undefined), (this._last = je.Undefined), (this._size = 0);
      }
      unshift(e) {
      ...
      _insert(e, t) {
        const n = new je(e);
        if (this._first === je.Undefined) (this._first = n), (this._last = n);
        else if (t) {
          const e = this._last;
      ...
      shift() {
        if (this._first !== je.Undefined) {
          const e = this._first.element;
          return this._remove(this._first), e;
        }
      }
      pop() {
        if (this._last !== je.Undefined) {
          const e = this._last.element;
          return this._remove(this._last), e;
        }
      }
      _remove(e) {
        if (e.prev !== je.Undefined && e.next !== je.Undefined) {
          const t = e.prev;
          (t.next = e.next), (e.next.prev = t);
        } else
          e.prev === je.Undefined && e.next === je.Undefined
            ? ((this._first = je.Undefined), (this._last = je.Undefined))
            : e.next === je.Undefined
            ? ((this._last = this._last.prev), (this._last.next = je.Undefined))
            : e.prev === je.Undefined &&
              ((this._first = this._first.next), (this._first.prev = je.Undefined));
        this._size -= 1;
      }
      *[Symbol.iterator]() {
        let e = this._first;
        for (; e !== je.Undefined; ) yield e.element, (e = e.next);
      }
    }
    const Ve = b.a.performance && 'function' == typeof b.a.performance.now;
    class $e {
      constructor(e) {
        (this._highResolution = Ve && e), (this._startTime = this._now()), (this._stopTime = -1);
      }
      static create(e = !0) {
        return new $e(e);
      }
      ...
      _now() {
        return this._highResolution ? b.a.performance.now() : Date.now();
      }
    }
    var qe;
    !(function (e) {
      ...
      (e.None = () => y.None),
        ...
        (e.any = function (...e) {
          return (t, n = null, r) => g(...e.map((e) => e((e) => t.call(n, e), null, r)));
        }),
        (e.reduce = o),
        (e.debounce = a),
        (e.latch = u),
    ...
    class Be {
      constructor(e) {
        ...
        (this._disposed = !1),
          ...
          (this._perfMon = (null === (t = this._options) || void 0 === t ? void 0 : t._profName)
            ? new We(this._options._profName)
            : void 0);
      }
      get event() {
        return (
            ...
            (this._event = (e, t, n) => {
              ...
              const s =
                ...
                a = p(() => {
                  if (
                    (s && s(),
                    !this._disposed && (o(), this._options && this._options.onLastListenerRemove))
                  ) {
                    (this._listeners && !this._listeners.isEmpty()) ||
                      this._options.onLastListenerRemove(this);
                  }
                });
              return n instanceof v ? n.add(a) : Array.isArray(n) && n.push(a), a;
            }),
          this._event
        );
      }
      ...
      dispose() {
        ...
        this._disposed ||
          ...
          null ===
            (r = null === (n = this._options) || void 0 === n ? void 0 : n.onLastListenerRemove) ||
            void 0 === r ||
            r.call(n),
          null === (i = this._leakageMon) || void 0 === i || i.dispose());
      }
    }
    const Ke = Object.freeze(function (e, t) {
    ...
    var He, Ye;
    ((Ye = He || (He = {})).isCancellationToken = function (e) {
      return (
        e === Ye.None ||
        e === Ye.Cancelled ||
        e instanceof ze ||
      ...
      (Ye.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: qe.None })),
      (Ye.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: Ke }));
    class ze {
      constructor() {
      ...
      get onCancellationRequested() {
        return this._isCancelled
          ? Ke
          : (this._emitter || (this._emitter = new Be()), this._emitter.event);
      }
      dispose() {
    ...
    class Ge {
      ...
      cancel() {
        this._token
          ? this._token instanceof ze && this._token.cancel()
      ...
      dispose(e = !1) {
        e && this.cancel(),
          ...
          this._token
            ? this._token instanceof ze && this._token.dispose()
            : (this._token = He.None);
      }
    }
    class Je {
    ...
    !(function () {
      function e(e, t, n = t, r = n) {
        Qe.define(e, t), Xe.define(e, n), Ze.define(e, r);
      }
      e(0, 'unknown'),
        e(1, 'Backspace'),
        e(2, 'Tab'),
      ...
      (function (e) {
        (e.toString = function (e) {
          ...
          (e.fromUserSettings = function (e) {
            return Xe.strToKeyCode(e) || Ze.strToKeyCode(e);
          });
      })(et || (et = {}));
    class Dt extends me {
      constructor(e, t, n, r) {
      ...
      equalsSelection(e) {
        return Dt.selectionsEqual(this, e);
      }
      ...
      setEndPosition(e, t) {
        return 0 === this.getDirection()
          ? new Dt(this.startLineNumber, this.startColumn, e, t)
          : new Dt(e, t, this.startLineNumber, this.startColumn);
      }
      getPosition() {
      ...
      setStartPosition(e, t) {
        return 0 === this.getDirection()
          ? new Dt(e, t, this.endLineNumber, this.endColumn)
          : new Dt(this.endLineNumber, this.endColumn, e, t);
      }
      static fromPositions(e, t = e) {
        return new Dt(e.lineNumber, e.column, t.lineNumber, t.column);
      }
      ...
      static createWithDirection(e, t, n, r, i) {
        return 0 === i ? new Dt(e, t, n, r) : new Dt(n, r, e, t);
      }
    }
    class Ft {
      constructor(e, t, n) {
    ...
    class Vt extends class {
      ...
      getText() {
        return (
          null === this._cachedTextValue && (this._cachedTextValue = this._lines.join(this._eol)),
      ...
      onEvents(e) {
        ...
        for (const e of t)
          this._acceptDeleteRange(e.range),
            this._acceptInsertText(new de(e.range.startLineNumber, e.range.startColumn), e.text);
      ...
      getWordAtPosition(e, t) {
        let n = (function e(t, n, r, i, o = Te) {
          if (r.length > o.maxLen) {
            let s = t - o.maxLen / 2;
            return (
              s < 0 ? (s = 0) : (i += s), e(t, n, (r = r.substring(s, t + o.maxLen / 2)), i, o)
            );
          }
          const s = Date.now(),
            a = t - 1 - i;
        ...
        return n ? new me(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn) : null;
      }
      words(e) {
        const t = this._lines,
    ...
    class $t {
      ...
      acceptNewModel(e) {
        this._models[e.url] = new Vt(re.parse(e.url), e.lines, e.EOL, e.versionId);
      }
      ...
      computeMoreMinimalEdits(e, t) {
        return Ut(this, void 0, void 0, function* () {
          ...
          t = t.slice(0).sort((e, t) => {
            if (e.range && t.range) return me.compareRangesUsingStarts(e.range, t.range);
            return (e.range ? 0 : 1) - (t.range ? 0 : 1);
          });
          for (let { range: e, text: o, eol: s } of t) {
            if (('number' == typeof s && (i = s), me.isEmpty(e) && !o)) continue;
            const t = n.getValueInRange(e);
            if (((o = o.replace(/\r\n|\n|\r/g, n.eol)), t === o)) continue;
            if (Math.max(o.length, t.length) > $t._diffLimit) {
              r.push({ range: e, text: o });
              continue;
            }
            const a = D(t, o, !1),
              u = n.offsetAt(me.lift(e).getStartPosition());
            for (const e of a) {
          ...
          e: for (let n of e) {
            ...
            if (e)
              for (let n of e.words(o))
                if (n !== t && isNaN(Number(n)) && (s.add(n), s.size > $t._suggestionsLimit))
                  break e;
          }
      ...
      navigateValueSet(e, t, n, r, i) {
        return Ut(this, void 0, void 0, function* () {
          ...
          return Fe.INSTANCE.navigateValueSet(t, a, u, l, n);
        });
      }
      loadForeignModule(e, t, n) {
        ...
        return this._foreignModuleFactory
          ? ((this._foreignModule = this._foreignModuleFactory(r, t)),
            Promise.resolve(_(this._foreignModule)))
      ...
      n.d(t, 'a', function () {
        ...
        (r = (() => {
          var t = {
              470: (t) => {
                ...
                var i = {
                  resolve: function () {
                    ...
                    return (
                      (i = r(i, !o)), o ? (i.length > 0 ? '/' + i : '/') : i.length > 0 ? i : '.'
                    );
                  },
                  ...
                  dirname: function (e) {
                    if ((n(e), 0 === e.length)) return '.';
                    for (
                      var t = e.charCodeAt(0), r = 47 === t, i = -1, o = !0, s = e.length - 1;
                      s >= 1;
                      --s
                    )
                    ...
                    if (void 0 !== t && t.length > 0 && t.length <= e.length) {
                      ...
                      for (r = e.length - 1; r >= 0; --r) {
                        ...
                        if (47 === l) {
                          ...
                          -1 === u && ((s = !1), (u = r + 1)),
                            a >= 0 &&
                              (l === t.charCodeAt(a) ? -1 == --a && (o = r) : ((a = -1), (o = u)));
                      }
                  ...
                  parse: function (e) {
                    ...
                    return (
                      -1 === s || -1 === u || 0 === h || (1 === h && s === u - 1 && s === a + 1)
                        ? -1 !== u &&
                          (t.base = t.name = 0 === a && o ? e.slice(1, u) : e.slice(a, u))
                        : (0 === a && o
              ...
              447: (t, n, r) => {
                var i;
                if ((r.r(n), r.d(n, { URI: () => g, Utils: () => x }), 'object' == typeof e))
                  i = 'win32' === e.platform;
                ...
                function b(e, t) {
                  ...
                  return (
                    -1 !== r && (n += encodeURIComponent(e.substring(r))), void 0 !== n ? n : e
                  );
                }
                function _(e) {
  ...
  function (e, t, n) {
    ...
    function o(e, t) {
      ...
      function p() {
        if (((i = ''), (m = 0), (o = r), (h = c), (d = f), r >= n)) return (o = n), (l = 17);
          ...
          case 47:
            ...
            if (42 === e.charCodeAt(r + 1)) {
              ...
              for (var y = n - 1, b = !1; r < y; ) {
                ...
                r++, a(_) && (13 === _ && 10 === e.charCodeAt(r) && r++, c++, (f = r));
              }
              return b || (r++, (m = 1)), (i = e.substring(p, r)), (l = 13);
            }
            return (i += String.fromCharCode(t)), r++, (l = 16);
          case 45:
            if (((i += String.fromCharCode(t)), ++r === n || !u(e.charCodeAt(r)))) return (l = 16);
          case 48:
          case 49:
          case 50:
          case 51:
            ...
            return (
              (i += (function () {
                ...
                if (r < e.length && 46 === e.charCodeAt(r)) {
                  if (!(++r < e.length && u(e.charCodeAt(r)))) return (m = 3), e.substring(t, r);
    ...
    function l(e, t, n) {
      var r, i, s, a, u;
      if (t) {
        for (a = t.offset, u = a + t.length, s = a; s > 0 && !h(e, s - 1); ) s--;
      ...
      function b() {
        var e = p.scan();
        for (m = !1; 15 === e || 14 === e; ) (m = m || 14 === e), (e = p.scan());
      ...
      for (; 17 !== S; ) {
        for (
          var E = p.getTokenOffset() + p.getTokenLength() + s, x = b(), w = '', N = !1;
          !m && (12 === x || 13 === x);
        ...
        17 === x && (w = n.insertFinalNewline ? d : ''), C(w, E, p.getTokenOffset() + s), (S = x);
      }
      return _;
    }
    function c(e, t) {
    ...
    function f(e, t, n) {
      ...
      function _(e, t, n) {
        if ((void 0 === t && (t = []), void 0 === n && (n = []), p(e), t.length + n.length > 0))
          ...
          case 3:
            return (function () {
              ...
              for (var e = !1; 4 !== i.getToken() && 17 !== i.getToken(); ) {
                if (5 === i.getToken()) {
                  if ((e || _(4, [], []), m(','), b(), 4 === i.getToken() && y)) break;
                } else e && _(6, [], []);
                S() || _(4, [], [4, 5]), (e = !0);
              }
          ...
          case 1:
            return (function () {
              ...
              for (var e = !1; 2 !== i.getToken() && 17 !== i.getToken(); ) {
                if (5 === i.getToken()) {
                  if ((e || _(4, [], []), m(','), b(), 2 === i.getToken() && y)) break;
                } else e && _(6, [], []);
                (10 !== i.getToken()
                  ? (_(3, [], [2, 5]), 0)
                  : (C(!1),
                    6 === i.getToken() ? (m(':'), b(), S() || _(4, [], [2, 5])) : _(5, [], [2, 5]),
                    1)) || _(4, [], [2, 5]),
                  (e = !0);
              }
    ...
    function J(e) {
      return z(e, '(?i)') ? new RegExp(e.substring(4), 'i') : new RegExp(e);
    }
    !(function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            var t = e;
            return ke.objectLiteral(t) && g.is(t.start) && g.is(t.end);
          });
      })(p || (p = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return ke.defined(t) && p.is(t.range) && (ke.string(t.uri) || ke.undefined(t.uri));
          });
      })(v || (v = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (p.is(t.targetSelectionRange) || ke.undefined(t.targetSelectionRange)) &&
              (p.is(t.originSelectionRange) || ke.undefined(t.originSelectionRange))
            );
          });
      })(y || (y = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              ke.numberRange(t.red, 0, 1) &&
              ke.numberRange(t.green, 0, 1) &&
              ke.numberRange(t.blue, 0, 1) &&
              ke.numberRange(t.alpha, 0, 1)
            );
          });
      })(b || (b = {})),
      (function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ke.string(t.label) &&
              (ke.undefined(t.textEdit) || k.is(t)) &&
              (ke.undefined(t.additionalTextEdits) || ke.typedArray(t.additionalTextEdits, k.is))
            );
          });
      })(C || (C = {})),
      (function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n, r, i) {
          ...
          return (
            ke.defined(n) && (o.startCharacter = n),
            ke.defined(r) && (o.endCharacter = r),
          ...
          (e.is = function (e) {
            var t = e;
            return (
              ke.uinteger(t.startLine) &&
              ke.uinteger(t.startLine) &&
              (ke.undefined(t.startCharacter) || ke.uinteger(t.startCharacter)) &&
              (ke.undefined(t.endCharacter) || ke.uinteger(t.endCharacter)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return ke.defined(t) && v.is(t.location) && ke.string(t.message);
          });
      })(E || (E = {})),
      (function (e) {
      ...
      (function (e) {
        e.is = function (e) {
          var t = e;
          return null != t && ke.string(t.href);
        };
      })(N || (N = {})),
      (function (e) {
        (e.create = function (e, t, n, r, i, o) {
          ...
          return (
            ke.defined(n) && (s.severity = n),
            ke.defined(r) && (s.code = r),
            ke.defined(i) && (s.source = i),
            ke.defined(o) && (s.relatedInformation = o),
            s
          );
        }),
          (e.is = function (e) {
            ...
            return (
              ...
              p.is(n.range) &&
              ke.string(n.message) &&
              (ke.number(n.severity) || ke.undefined(n.severity)) &&
              (ke.integer(n.code) || ke.string(n.code) || ke.undefined(n.code)) &&
              (ke.undefined(n.codeDescription) ||
                ke.string(null === (t = n.codeDescription) || void 0 === t ? void 0 : t.href)) &&
              (ke.string(n.source) || ke.undefined(n.source)) &&
              (ke.undefined(n.relatedInformation) || ke.typedArray(n.relatedInformation, E.is))
            );
          });
      })(L || (L = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          return ke.defined(n) && n.length > 0 && (i.arguments = n), i;
        }),
          (e.is = function (e) {
            var t = e;
      ...
      (function (e) {
        (e.replace = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return ke.objectLiteral(t) && ke.string(t.newText) && p.is(t.range);
          });
      })(k || (k = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              ke.objectLiteral(t) &&
              ke.string(t.label) &&
              (ke.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) &&
              (ke.string(t.description) || void 0 === t.description)
            );
          });
      })(O || (O = {})),
      (function (e) {
              ...
              (void 0 === t.options ||
                ((void 0 === t.options.recursive || ke.boolean(t.options.recursive)) &&
                  (void 0 === t.options.ignoreIfNotExists ||
                    ke.boolean(t.options.ignoreIfNotExists)))) &&
              (void 0 === t.annotationId || I.is(t.annotationId))
            );
          });
      })(F || (F = {})),
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function (e) {
                return ke.string(e.kind) ? R.is(e) || D.is(e) || F.is(e) : M.is(e);
              }))
          );
        };
      })(j || (j = {}));
      ...
      Le = (function () {
        ...
        return (
          ...
          (e.prototype.manage = function (e, t) {
            var n;
            if (
              (I.is(e) ? (n = e) : ((n = this.nextId()), (t = e)), void 0 !== this._annotations[n])
            )
        ...
        (this._textEditChanges = Object.create(null)),
          void 0 !== e
            ? ((this._workspaceEdit = e),
              e.documentChanges
                ? ((this._changeAnnotations = new Le(e.changeAnnotations)),
      ...
      Object.defineProperty(e.prototype, 'edit', {
        ...
        (e.prototype.getTextEditChange = function (e) {
          if (Z.is(e)) {
            ...
            if (!(r = this._textEditChanges[t.uri])) {
              ...
              this._workspaceEdit.documentChanges.push(n),
                (r = new Ne(i, this._changeAnnotations)),
          ...
          if (!(r = this._textEditChanges[e])) {
            var i = [];
            (this._workspaceEdit.changes[e] = i), (r = new Ne(i)), (this._textEditChanges[e] = r);
          }
          return r;
        }),
        ...
        (e.prototype.createFile = function (e, t, n) {
          ...
          if (
            ...
            void 0 === r
              ? (i = R.create(e, n))
              : ((o = I.is(r) ? r : this._changeAnnotations.manage(r)), (i = R.create(e, n, o))),
        ...
        (e.prototype.renameFile = function (e, t, n, r) {
          ...
          if (
            ...
            void 0 === i
              ? (o = D.create(e, t, r))
              : ((s = I.is(i) ? i : this._changeAnnotations.manage(i)), (o = D.create(e, t, r, s))),
        ...
        (e.prototype.deleteFile = function (e, t, n) {
          ...
          if (
            ...
            void 0 === r
              ? (i = F.create(e, n))
              : ((o = I.is(r) ? r : this._changeAnnotations.manage(r)), (i = F.create(e, n, o))),
            this._workspaceEdit.documentChanges.push(i),
            void 0 !== o)
          )
            return o;
    ...
    !(function (e) {
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              ke.defined(t) && ke.string(t.uri) && (null === t.version || ke.integer(t.version))
            );
          });
      })(Z || (Z = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            ...
            return (
              ke.defined(t) &&
              ke.string(t.uri) &&
              ke.string(t.languageId) &&
              ke.integer(t.version) &&
              ke.string(t.text)
            );
          });
      })(ee || (ee = {})),
      ...
      (function (e) {
        e.is = function (e) {
          var t = e;
          return ke.objectLiteral(e) && te.is(t.kind) && ke.string(t.value);
        };
      })(ne || (ne = {})),
      (function (e) {
        (e.Text = 1),
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return t && ke.string(t.newText) && p.is(t.insert) && p.is(t.replace);
          });
      })(se || (se = {})),
      (function (e) {
      ...
      (function (e) {
        (e.fromPlainText = function (e) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              ke.string(t) || (ke.objectLiteral(t) && ke.string(t.language) && ke.string(t.value))
            );
          });
      })(ce || (ce = {})),
      (function (e) {
        e.is = function (e) {
          ...
          return (
            !!t &&
            ke.objectLiteral(t) &&
            (ne.is(t.contents) || ce.is(t.contents) || ke.typedArray(t.contents, ce.is)) &&
      ...
      (function (e) {
        e.create = function (e, t) {
          ...
          var i = { label: e };
          return (
            ke.defined(t) && (i.documentation = t),
            ke.defined(n) ? (i.parameters = n) : (i.parameters = []),
            i
          );
        };
      })(de || (de = {})),
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              ke.defined(t) &&
              ke.typedArray(t.diagnostics, L.is) &&
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              t &&
              ke.string(t.title) &&
              (void 0 === t.diagnostics || ke.typedArray(t.diagnostics, L.is)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          var n = { range: e };
          return ke.defined(t) && (n.data = t), n;
        }),
          (e.is = function (e) {
            var t = e;
            return ke.defined(t) && p.is(t.range) && (ke.undefined(t.command) || T.is(t.command));
          });
      })(Ae || (Ae = {})),
      (function (e) {
        (e.create = function (e, t) {
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              ke.defined(t) && p.is(t.range) && (ke.undefined(t.target) || ke.string(t.target))
            );
          });
      })(xe || (xe = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (t) {
            var n = t;
            return void 0 !== n && p.is(n.range) && (void 0 === n.parent || e.is(n.parent));
          });
      })(we || (we = {}));
    var Te;
    !(function (e) {
    ...
    var Ie,
      ...
      Re = (function () {
        ...
        return (
          ...
          (e.prototype.getLineOffsets = function () {
            return (
              void 0 === this._lineOffsets && (this._lineOffsets = De(this._content, !0)),
              this._lineOffsets
            );
          }),
          (e.prototype.positionAt = function (e) {
    ...
    !(function (e) {
      ...
      ((Me || (Me = {})).LATEST = {
        textDocument: {
          completion: {
            completionItem: {
              documentationFormat: [te.Markdown, te.PlainText],
    ...
    var qe,
      ...
      He = {
        ...
        'date-time': {
          errorMessage: Ke('dateTimeFormatWarning', 'String is not a RFC3339 date-time.'),
          pattern:
            /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i,
        },
        date: {
          errorMessage: Ke('dateFormatWarning', 'String is not a RFC3339 date.'),
          pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/i,
        },
        time: {
          errorMessage: Ke('timeFormatWarning', 'String is not a RFC3339 time.'),
          pattern:
            /^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i,
        },
        email: {
          errorMessage: Ke('emailFormatWarning', 'String is not an e-mail address.'),
          pattern:
    ...
    var nt = (function () {
        ...
        return (
          ...
          (e.prototype.include = function (e) {
            return (-1 === this.focusOffset || at(e, this.focusOffset)) && e !== this.exclude;
          }),
    ...
    var ut = (function () {
      ...
      return (
        ...
        (e.prototype.getMatchingSchemas = function (e, t, n) {
          void 0 === t && (t = -1);
          var r = new nt(t, n);
          return this.root && e && lt(this.root, e, new it(), r), r.schemas;
        }),
        e
      );
    })();
            ...
            !(function (e, t, n, r) {
              ...
              if (Array.isArray(t.required))
                for (var l = 0, c = t.required; l < c.length; l++) {
                  ...
                  if (!i[h]) {
                    ...
                    n.problems.push({
                      location: d,
                      message: Ke('MissingRequiredPropWarning', 'Missing property "{0}".', h),
                    });
                  }
                }
              var m = function (e) {
                    ...
                    if (Y(v))
                      if (v) n.propertiesMatches++, n.propertiesValueMatches++;
                        ...
                        n.problems.push({
                          ...
                          message:
                            t.errorMessage ||
                            Ke('DisallowedExtraPropWarning', 'Property {0} is not allowed.', h),
                        });
                      }
                    else {
                      var b = new it();
                      lt(k, v, b, r), n.mergePropertyMatch(b);
                    }
                }
              if (t.patternProperties)
                for (var _ = 0, C = Object.keys(t.patternProperties); _ < C.length; _++)
                  for (var S = C[_], A = J(S), E = 0, x = o.slice(0); E < x.length; E++) {
                    h = x[E];
                    if (A.test(h))
                      if ((m(h), (k = i[h])))
              ...
              if ('object' == typeof t.additionalProperties)
                for (var w = 0, N = o; w < N.length; w++) {
                  ...
                  if ((k = i[h])) {
                    b = new it();
                    lt(k, t.additionalProperties, b, r), n.mergePropertyMatch(b);
                  }
                }
                ...
                for (var O = 0, I = Object.keys(t.dependencies); O < I.length; O++) {
                  ...
                  if (i[u]) {
                    ...
                    if (Array.isArray(P))
                      ...
                      b = new it();
                      lt(e, v, b, r), n.mergePropertyMatch(b);
                    }
                  }
                }
              var F = tt(t.propertyNames);
              if (F)
                for (var j = 0, U = e.properties; j < U.length; j++) {
                  var V = U[j];
                  (u = V.keyNode) && lt(u, F, n, rt.instance);
                }
            })(i, t, n, r);
            break;
          case 'array':
            !(function (e, t, n, r) {
              if (Array.isArray(t.items)) {
                for (var i = t.items, o = 0; o < i.length; o++) {
                  var s = tt(i[o]),
                    a = new it();
                  (f = e.items[o])
                    ? (lt(f, s, a, r), n.mergePropertyMatch(a))
                ...
                if (e.items.length > i.length)
                  if ('object' == typeof t.additionalItems)
                    for (var u = i.length; u < e.items.length; u++) {
                      a = new it();
                      lt(e.items[u], t.additionalItems, a, r), n.mergePropertyMatch(a);
                    }
                  else
                    !1 === t.additionalItems &&
                      n.problems.push({
                ...
                if (l)
                  for (var c = 0, h = e.items; c < h.length; c++) {
                    var f = h[c];
                    a = new it();
                    lt(f, l, a, r), n.mergePropertyMatch(a);
                  }
              }
              var d = tt(t.contains);
              if (d) {
                e.items.some(function (e) {
                  var t = new it();
                  return lt(e, d, t, rt.instance), !t.hasProblems();
                }) ||
                  n.problems.push({
                    location: { offset: e.offset, length: e.length },
                    message:
                      t.errorMessage ||
                      Ke('requiredItemMissingWarning', 'Array does not contain required item.'),
                  });
              }
              K(t.minItems) &&
              ...
              if (!0 === t.uniqueItems) {
                ...
                m.some(function (e, t) {
                  ...
                  n.problems.push({
                    location: { offset: e.offset, length: e.length },
                    message: Ke('uniqueItemsWarning', 'Array has duplicate items.'),
                  });
              }
            })(i, t, n, r);
            break;
                  ...
                  case 'uri-reference':
                    ...
                    if (e.value) {
                      ...
                      s
                        ? s[2] ||
                          'uri' !== t.format ||
                          (o = Ke('uriSchemeMissing', 'URI with a scheme is expected.'))
                        : (o = Ke('uriMissing', 'URI is expected.'));
                    } else o = Ke('uriEmpty', 'URI expected.');
                    o &&
                      n.problems.push({
                        location: { offset: e.offset, length: e.length },
                        message:
                          t.patternErrorMessage ||
                          t.errorMessage ||
                          Ke('uriFormatWarning', 'String is not a URI: {0}', o),
                      });
                    break;
                  case 'color-hex':
                  case 'date-time':
          ...
          case 'number':
            !(function (e, t, n, r) {
              ...
              function o(e) {
                ...
                return (
                  n && {
                    ...
                    multiplier:
                      ((null === (t = n[2]) || void 0 === t ? void 0 : t.length) || 0) -
                      (parseInt(n[3]) || 0),
                  }
                );
              }
              if (K(t.multipleOf)) {
                ...
                if (Number.isInteger(t.multipleOf)) s = i % t.multipleOf;
                  ...
                  if (a && u) {
                    ...
                    u.multiplier < a.multiplier ? (u.value *= l) : (a.value *= l),
                      (s = u.value % a.value);
                  }
                }
                0 !== s &&
              ...
              K(m) &&
                ...
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: Ke('minimumWarning', 'Value is below the minimum of {0}.', m),
                });
              ...
              K(g) &&
                ...
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: Ke('maximumWarning', 'Value is above the maximum of {0}.', g),
                });
            })(i, t, n);
            break;
          case 'property':
            return lt(i.valueNode, t, n, r);
        }
        !(function () {
          function e(e) {
            ...
            : t.type &&
              (e(t.type) ||
                n.problems.push({
                  ...
                  message:
                    t.errorMessage ||
                    Ke('typeMismatchWarning', 'Incorrect type. Expected "{0}".', t.type),
                }));
          ...
          if (u) {
            ...
            lt(i, u, l, c),
              l.hasProblems() ||
                n.problems.push({
                  location: { offset: i.offset, length: i.length },
                  message: Ke('notSchemaWarning', 'Matches a schema that is not allowed.'),
                });
          ...
          var m = function (e, t) {
            for (var o = [], s = void 0, a = 0, u = e; a < u.length; a++) {
              var l = tt(u[a]),
                c = new it(),
                h = r.newSub();
              if ((lt(i, l, c, h), c.hasProblems() || o.push(l), s))
                if (t || c.hasProblems() || s.validationResult.hasProblems()) {
                  ...
                  f > 0
                    ...
                    : 0 === f &&
                      (s.matchingSchemas.merge(h), s.validationResult.mergeEnumValues(c));
                } else
          ...
          p &&
            (function (e, t, n) {
              var o = tt(e),
                s = new it(),
                a = r.newSub();
              lt(i, o, s, a), r.merge(a), s.hasProblems() ? n && g(n) : t && g(t);
            })(p, tt(t.then), tt(t.else));
          if (Array.isArray(t.enum)) {
            for (var v = ot(i), y = !1, b = 0, _ = t.enum; b < _.length; b++) {
              var C = _[b];
              if (B(v, C)) {
                y = !0;
                break;
          ...
          if (H(t.const)) {
            B((v = ot(i)), t.const)
              ...
              : (n.problems.push({
                  ...
                  message:
                    t.errorMessage ||
                    Ke('constWarning', 'Value must be {0}.', JSON.stringify(t.const)),
                }),
                (n.enumValueMatch = !1)),
    ...
    function ct(e, t) {
      ...
      function c() {
        switch (o.getTokenError()) {
          case 4:
            return (
              l(Ke('InvalidUnicode', 'Invalid unicode sequence in string.'), Pe.InvalidUnicode), !0
            );
          case 5:
            return (
              l(
                Ke('InvalidEscapeCharacter', 'Invalid escape character in string.'),
                Pe.InvalidEscapeCharacter,
              ),
              !0
            );
          case 3:
            return (
              l(Ke('UnexpectedEndOfNumber', 'Unexpected end of number.'), Pe.UnexpectedEndOfNumber),
              !0
            );
          case 1:
            return (
              l(
                Ke('UnexpectedEndOfComment', 'Unexpected end of comment.'),
                Pe.UnexpectedEndOfComment,
              ),
              !0
            );
          case 2:
            return (
              l(Ke('UnexpectedEndOfString', 'Unexpected end of string.'), Pe.UnexpectedEndOfString),
              !0
            );
          case 6:
            return (
      ...
      var f = new Xe(void 0, 0, 0);
      function d(t, n) {
        var r = new Ze(t, o.getTokenOffset(), f),
          i = m(r);
        if (!i) {
          if (16 !== o.getToken()) return;
          l(Ke('DoubleQuotesExpected', 'Property keys must be doublequoted'), Pe.Undefined);
          var s = new Xe(r, o.getTokenOffset(), o.getTokenLength());
        ...
        if (
          (c
            ? (u(
                Ke('DuplicateKeyWarning', 'Duplicate object key'),
                Pe.DuplicateKey,
                r.keyNode.offset,
          ...
          (l(Ke('ColonExpected', 'Colon expected'), Pe.ColonExpected),
          10 === o.getToken() &&
            e.positionAt(i.offset + i.length).line < e.positionAt(o.getTokenOffset()).line)
        )
          return (r.length = i.length), r;
        var h = g(r);
        return h
          ? ((r.valueNode = h), (r.length = h.offset + h.length - r.offset), r)
          : l(Ke('ValueExpected', 'Value expected'), Pe.ValueExpected, r, [], [2, 5]);
      }
      function m(e) {
        if (10 === o.getToken()) {
          var t = new Xe(e, o.getTokenOffset());
      ...
      function g(e) {
        return (
          (function (e) {
            if (3 === o.getToken()) {
              var t = new Je(e, o.getTokenOffset());
              a();
              for (var n = !1; 4 !== o.getToken() && 17 !== o.getToken(); ) {
                if (5 === o.getToken()) {
                  n || l(Ke('ValueExpected', 'Value expected'), Pe.ValueExpected);
                  var r = o.getTokenOffset();
                  if ((a(), 4 === o.getToken())) {
                    n && u(Ke('TrailingComma', 'Trailing comma'), Pe.TrailingComma, r, r + 1);
                    continue;
                  }
                } else n && l(Ke('ExpectedComma', 'Expected comma'), Pe.CommaExpected);
                var i = g(t);
                i
                  ? t.items.push(i)
                  : l(
                      Ke('PropertyExpected', 'Value expected'),
                      Pe.ValueExpected,
                      void 0,
                      [],
                      [4, 5],
              ...
              return 4 !== o.getToken()
                ? l(
                    Ke('ExpectedCloseBracket', 'Expected comma or closing bracket'),
                    Pe.CommaOrCloseBacketExpected,
                    t,
                  )
                : h(t, !0);
            }
          ...
          (function (e) {
            if (1 === o.getToken()) {
              var t = new et(e, o.getTokenOffset()),
                n = Object.create(null);
              a();
              for (var r = !1; 2 !== o.getToken() && 17 !== o.getToken(); ) {
                if (5 === o.getToken()) {
                  r || l(Ke('PropertyExpected', 'Property expected'), Pe.PropertyExpected);
                  var i = o.getTokenOffset();
                  if ((a(), 2 === o.getToken())) {
                    r && u(Ke('TrailingComma', 'Trailing comma'), Pe.TrailingComma, i, i + 1);
                    continue;
                  }
                } else r && l(Ke('ExpectedComma', 'Expected comma'), Pe.CommaExpected);
                var s = d(t, n);
                s
                  ? t.properties.push(s)
                  : l(
                      Ke('PropertyExpected', 'Property expected'),
                      Pe.PropertyExpected,
                      void 0,
                      [],
                      [2, 5],
              ...
              return 2 !== o.getToken()
                ? l(
                    Ke('ExpectedCloseBrace', 'Expected comma or closing brace'),
                    Pe.CommaOrCloseBraceExpected,
                    t,
                  )
                : h(t, !0);
            }
            ...
            if (11 === o.getToken()) {
              ...
              if (0 === o.getTokenError()) {
                ...
                try {
                  var r = JSON.parse(n);
                  if (!K(r))
                    return l(Ke('InvalidNumberFormat', 'Invalid number format.'), Pe.Undefined, t);
                  t.value = r;
                } catch (e) {
                  return l(Ke('InvalidNumberFormat', 'Invalid number format.'), Pe.Undefined, t);
                }
          ...
          (function (e) {
            switch (o.getToken()) {
              case 7:
                return h(new ze(e, o.getTokenOffset()), !0);
              case 8:
                return h(new Ge(e, !0, o.getTokenOffset()), !0);
              case 9:
                return h(new Ge(e, !1, o.getTokenOffset()), !0);
              default:
                return;
            }
          })(e)
      ...
      return (
        17 !== a() &&
          ((v = g(v))
            ? 17 !== o.getToken() &&
              l(Ke('End of file expected', 'End of file expected.'), Pe.Undefined)
            : l(Ke('Invalid symbol', 'Expected a JSON object, array or literal.'), Pe.Undefined)),
        new ut(v, n, s)
      );
    }
    var ht = $e(),
        ...
        return (
          ...
          (e.prototype.doComplete = function (e, t, n) {
            ...
            if (a && s === a.offset + a.length && s > 0) {
              var u = o[s - 1];
              (('object' === a.type && '}' === u) || ('array' === a.type && ']' === u)) &&
                (a = a.parent);
            }
            var l,
            ...
            if (
              ...
              var h = s - c.length;
              h > 0 && '"' === o[h - 1] && h--, (l = p.create(e.positionAt(h), t));
            } else l = p.create(e.positionAt(a.offset), e.positionAt(a.offset + a.length));
            var f = {},
              d = {
                add: function (e) {
                  var t = e.label,
                  ...
                  if (n)
                    ...
                    l && void 0 !== e.insertText && (e.textEdit = k.replace(l, e.insertText)),
                      (e.label = t),
                      (f[t] = e),
                      i.items.push(e);
                  }
            ...
            return this.schemaService.getSchemaForResource(e.uri, n).then(function (t) {
              ...
              if (a && 'object' === a.type) {
                ...
                a.properties.forEach(function (e) {
                  (g && g === e) || (f[e.keyNode.value] = ue.create('__'));
                });
                var v = '';
                ...
                if ('object' == typeof a && !a.deprecationMessage && !a.doNotSuggest) {
                  var u = function (e, t) {
                    ...
                    var n = {
                      ...
                      filterText: s.getFilterTextForValue(e),
                      documentation:
                        t || s.fromMarkup(a.markdownDescription) || a.description || '',
                    };
          ...
          (e.prototype.getSchemaLessValueCompletions = function (e, t, n, r, i) {
            ...
            if ('property' === t.type && n > (t.colonOffset || 0)) {
              var l = t.valueNode;
              if (l && (n > l.offset + l.length || 'object' === l.type || 'array' === l.type))
                return;
              var c = t.keyNode.value;
              e.visit(function (e) {
                return (
                  'property' === e.type && e.keyNode.value === c && e.valueNode && u(e.valueNode),
                  !0
                );
              }),
                '$schema' === c &&
                    ...
                    if ('array' === n.type && m.schema.items)
                      if (Array.isArray(m.schema.items)) {
                        ...
                        g < m.schema.items.length &&
                          this.addSchemaValueCompletions(m.schema.items[g], h, o, s);
                      } else this.addSchemaValueCompletions(m.schema.items, h, o, s);
                    if (void 0 !== u) {
                      var p = !1;
                      if (m.schema.properties)
                        (_ = m.schema.properties[u]) &&
                          ((p = !0), this.addSchemaValueCompletions(_, h, o, s));
                      if (m.schema.patternProperties && !p)
                        for (
                          var v = 0, y = Object.keys(m.schema.patternProperties);
                          v < y.length;
                          v++
                        ) {
                          var b = y[v];
          ...
          (e.prototype.addDefaultValueCompletions = function (e, t, n, r) {
            ...
            if (H(e.default)) {
              ...
              n.add({
                ...
                insertTextFormat: ie.Snippet,
                detail: ht('json.suggest.default', 'Default value'),
              }),
                (o = !0);
            }
          ...
          (e.prototype.addFillerValueCompletions = function (e, t, n) {
            e.object &&
              n.add({
                ...
                insertTextFormat: ie.Snippet,
                detail: ht('defaults.object', 'New object'),
                documentation: '',
              }),
              e.array &&
                n.add({
                  ...
                  insertText: this.getInsertTextForGuessedValue([], t),
                  insertTextFormat: ie.Snippet,
                  detail: ht('defaults.array', 'New array'),
                  documentation: '',
                });
          }),
              ...
              (function e(t, n, r) {
                if (null !== t && 'object' == typeof t) {
                  ...
                  if (Array.isArray(t)) {
                    if (0 === t.length) return '[]';
                    for (var o = '[\n', s = 0; s < t.length; s++)
                      (o += i + e(t[s], i, r)), s < t.length - 1 && (o += ','), (o += '\n');
                    return (o += n + ']');
                  }
                  var a = Object.keys(t);
            ...
            if (t) {
              ...
              if (
                (t.enum &&
                  ...
                  (a += t.enum.length)),
                H(t.default) && (o || (o = this.getInsertTextForGuessedValue(t.default, '')), a++),
          ...
          (e.prototype.findItemAtOffset = function (e, t, n) {
            for (var r = U(t.getText(), !0), i = e.items, o = i.length - 1; o >= 0; o--) {
              var s = i[o];
              if (n > s.offset + s.length)
                return (
                  r.setPosition(s.offset + s.length),
                  5 === r.scan() && n >= r.getTokenOffset() + r.getTokenLength() ? o + 1 : o
                );
          ...
          (e.prototype.isInComment = function (e, t, n) {
            var r = U(e.getText(), !1);
            r.setPosition(t);
            for (var i = r.scan(); 17 !== i && r.getTokenOffset() + r.getTokenLength() < n; )
              i = r.scan();
            return (12 === i || 13 === i) && r.getTokenOffset() <= n;
          }),
          (e.prototype.fromMarkup = function (e) {
            if (e && this.doesSupportMarkdown()) return { kind: te.Markdown, value: e };
          }),
          (e.prototype.doesSupportMarkdown = function () {
            if (!H(this.supportsMarkdown)) {
              ...
              this.supportsMarkdown =
                ...
                -1 !== e.completionItem.documentationFormat.indexOf(te.Markdown);
            }
          ...
          (e.prototype.doesSupportsCommitCharacters = function () {
            if (!H(this.supportsCommitCharacters)) {
              ...
              this.supportsCommitCharacters =
                e && e.completionItem && !!e.completionItem.commitCharactersSupport;
            }
      ...
      dt = (function () {
        ...
        return (
          (e.prototype.doHover = function (e, t, n) {
            ...
            if ('string' === i.type) {
              var s = i.parent;
              if (s && 'property' === s.type && s.keyNode === i && !(i = s.valueNode))
                return this.promise.resolve(null);
            }
            for (
              var a = p.create(e.positionAt(o.offset), e.positionAt(o.offset + o.length)),
                u = function (e) {
              ...
              if (e && i) {
                ...
                t.every(function (e) {
                  if (
                    ...
                    e.schema &&
                    ((r = r || e.schema.title),
                    (o = o || e.schema.markdownDescription || mt(e.schema.description)),
                    e.schema.enum)
                  ) {
                    var t = e.schema.enum.indexOf(ot(i));
                    e.schema.markdownEnumDescriptions
                      ? (s = e.schema.markdownEnumDescriptions[t])
                      : e.schema.enumDescriptions && (s = mt(e.schema.enumDescriptions[t])),
          ...
          case '*':
            ...
            if (s)
              ...
              ('/' === d || void 0 === d || ',' === d || '}' === d)
                ? ('/' === d
                    ? l++
                    : '/' === h && i.endsWith('\\/') && (i = i.substr(0, i.length - 2)),
                  (i += '((?:[^/]*(?:/|$))*)'))
                : (i += '([^/]*)');
            else i += '.*';
            break;
              ...
              o || (i = i.substring(1)),
                i.length > 0 &&
                  ...
                  this.globWrappers.push({
                    regexp: pt('**/' + i, { extended: !0, globstar: !0 }),
                    include: o,
                  }));
            }
            this.uris = t;
      ...
      bt = (function () {
        function e(e, t, n) {
          (this.service = e),
            (this.url = t),
            (this.dependencies = {}),
            n && (this.unresolvedSchema = this.service.promise.resolve(new _t(n)));
        }
        return (
          ...
          (e.prototype.getSectionRecursive = function (e, t) {
            ...
            if (t.patternProperties)
              for (var r = 0, i = Object.keys(t.patternProperties); r < i.length; r++) {
                var o = i[r];
                if (J(o).test(n)) return this.getSectionRecursive(e, t.patternProperties[o]);
              }
            else {
              if ('object' == typeof t.additionalProperties)
        ...
        return (
          ...
          (e.prototype.loadSchema = function (e) {
            if (!this.requestService) {
              ...
              return this.promise.resolve(new _t({}, [t]));
            }
            return this.requestService(e).then(
              ...
              function (t) {
                ...
                return (
                  r.length > 1 && (n = r[1]),
                  G(n, '.') && (n = n.substr(0, n.length - 1)),
                  new _t({}, [
                    vt('json.schema.nocontent', "Unable to load schema from '{0}': {1}.", xt(e), n),
                  ])
                );
              },
            );
          ...
          (e.prototype.resolveSchemaContent = function (e, t, n) {
            ...
            if (o.$schema) {
              ...
              if ('http://json-schema.org/draft-03/schema' === s)
                return this.promise.resolve(
                  new Ct({}, [
                    vt('json.schema.draft03.notsupported', 'Draft-03 schemas are not supported.'),
                  ]),
                );
            ...
            var a = this.contextService,
              u = function (e, t, n, r) {
                ...
                if (s)
                  for (var a in s) s.hasOwnProperty(a) && !e.hasOwnProperty(a) && (e[a] = s[a]);
                else
                  i.push(
                    vt('json.schema.invalidref', "$ref '{0}' in '{1}' can not be resolved.", o, n),
                  );
              },
          ...
          (e.prototype.getSchemaForResource = function (e, t) {
            if (t && t.root && 'object' === t.root.type) {
              var n = t.root.properties.filter(function (e) {
                return (
                  '$schema' === e.keyNode.value && e.valueNode && 'string' === e.valueNode.type
                );
              });
              if (n.length > 0) {
                var r = n[0].valueNode;
            ...
            for (
              var s = Object.create(null),
                ...
                u = (function (e) {
                  try {
                    return gt.a.parse(e).with({ fragment: null, query: null }).toString();
                  } catch (t) {
                    return e;
                  }
                })(e),
          ...
          (e.prototype.getMatchingSchemas = function (e, t, n) {
            if (n) {
              var r = n.id || 'schemaservice://untitled/matchingSchemas/' + At++;
              return this.resolveSchemaContent(new _t(n), r, {}).then(function (e) {
        ...
        return (
          ...
          (e.prototype.doValidation = function (e, t, n, r) {
            ...
            var o = [],
              ...
              u = function (r) {
                var s = (null == n ? void 0 : n.trailingCommas) ? Tt(n.trailingCommas) : x.Error,
                  u = (null == n ? void 0 : n.comments) ? Tt(n.comments) : i.commentSeverity,
                  l = (null == n ? void 0 : n.schemaValidation)
                    ? Tt(n.schemaValidation)
                    : x.Warning,
                  c = (null == n ? void 0 : n.schemaRequest) ? Tt(n.schemaRequest) : x.Warning;
                if (r) {
                  if (r.errors.length && t.root && c) {
                    ...
                    if (f && '$schema' === f.keyNode.value) {
                      var d = f.valueNode || f,
                        m = p.create(e.positionAt(d.offset), e.positionAt(d.offset + d.length));
                      a(L.create(m, r.errors[0], c, Pe.SchemaResolveError));
                    } else {
                      m = p.create(e.positionAt(h.offset), e.positionAt(h.offset + 1));
                      a(L.create(m, r.errors[0], c, Pe.SchemaResolveError));
                    }
                  } else if (l) {
                  ...
                  (function e(t) {
                    ...
                    (function e(t) {
                      if (t && 'object' == typeof t) {
                        ...
                        var n = t;
                        if (Y(n.allowsTrailingCommas)) return n.allowsTrailingCommas;
                        if (t.allOf)
                ...
                if ('number' == typeof u) {
                  var _ = wt('InvalidCommentToken', 'Comments are not permitted in JSON.');
                  t.comments.forEach(function (e) {
                    a(L.create(e, _, u, Pe.CommentNotPermitted));
                  });
                }
                return o;
              };
            if (r) {
              var l = r.id || 'schemaservice://untitled/' + Lt++;
              return this.jsonSchemaService
                .resolveSchemaContent(new _t(r), l, {})
                .then(function (e) {
                  return u(e);
                });
            }
        ...
        (e.prototype.findDocumentSymbols = function (e, t, n) {
          ...
          if (
            ('vscode://defaultsettings/keybindings.json' === s ||
              G(s.toLowerCase(), '/user/keybindings.json')) &&
            'array' === i.type
          ) {
              ...
              if ('object' === c.type)
                for (var h = 0, f = c.properties; h < f.length; h++) {
                  ...
                  if ('key' === d.keyNode.value && d.valueNode) {
                    var m = v.create(e.uri, Pt(e, c));
                    if (
                      (a.push({ name: ot(d.valueNode), kind: pe.Function, location: m }), --o <= 0)
                    )
          ...
          return y && n && n.onResultLimitExceeded && n.onResultLimitExceeded(s), b;
        }),
    ...
    function Pt(e, t) {
      return p.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length));
    }
    var Mt = $e(),
      Rt = {
        schemaAssociations: [],
      ...
      Dt = {
        id: Mt('schema.json.id', 'A unique identifier for the schema.'),
        $schema: Mt('schema.json.$schema', 'The schema to verify this document against.'),
        title: Mt('schema.json.title', 'A descriptive title of the element.'),
        description: Mt(
          'schema.json.description',
          'A long description of the element. Used in hover menus and suggestions.',
        ),
        default: Mt('schema.json.default', 'A default value. Used by suggestions.'),
        multipleOf: Mt(
          'schema.json.multipleOf',
          'A number that should cleanly divide the current value (i.e. have no remainder).',
        ),
        maximum: Mt('schema.json.maximum', 'The maximum numerical value, inclusive by default.'),
        exclusiveMaximum: Mt(
          'schema.json.exclusiveMaximum',
          'Makes the maximum property exclusive.',
        ),
        minimum: Mt('schema.json.minimum', 'The minimum numerical value, inclusive by default.'),
        exclusiveMinimum: Mt(
          'schema.json.exclusiveMininum',
          'Makes the minimum property exclusive.',
        ),
        maxLength: Mt('schema.json.maxLength', 'The maximum length of a string.'),
        minLength: Mt('schema.json.minLength', 'The minimum length of a string.'),
        pattern: Mt(
          'schema.json.pattern',
        ...
        enum: Mt('schema.json.enum', 'The set of literal values that are valid.'),
        type: Mt(
          'schema.json.type',
        ...
        format: Mt('schema.json.format', 'Describes the format expected for the value.'),
        allOf: Mt('schema.json.allOf', 'An array of schemas, all of which must match.'),
        anyOf: Mt('schema.json.anyOf', 'An array of schemas, where at least one must match.'),
        oneOf: Mt('schema.json.oneOf', 'An array of schemas, exactly one of which must match.'),
        not: Mt('schema.json.not', 'A schema which must not match.'),
        $id: Mt('schema.json.$id', 'A unique identifier for the schema.'),
        $ref: Mt('schema.json.$ref', 'Reference a definition hosted on any location.'),
        $comment: Mt(
          'schema.json.$comment',
    ...
    for (var Ft in Rt.schemas) {
      var jt = Rt.schemas[Ft];
      for (var Ut in jt.properties) {
        var Vt = jt.properties[Ut];
        'boolean' == typeof Vt && (Vt = jt.properties[Ut] = {});
        var $t = Dt[Ut];
        $t ? (Vt.description = $t) : console.log(Ut + ": localize('schema.json." + Ut + '\', "")');
      }
    }
    function qt(e, t) {
      var n = [],
        ...
        switch (a) {
          ...
          case 13:
            ...
            1 === s.getTokenError() && f + 1 < e.lineCount
              ...
              : f < d && (u({ startLine: f, endLine: d, kind: S.Comment }), (o = f));
            break;
          case 12:
            var m = e
              .getText()
            ...
            if (m) {
              ...
              if (m[1]) {
                ...
                for (var p = i.length - 1; p >= 0 && i[p].kind !== S.Region; ) p--;
                if (p >= 0) {
                  l = i[p];
                  (i.length = p),
                    h > l.startLine &&
      ...
      for (p = 0; p < n.length; p++) {
        var w;
        'number' == typeof (w = r[p]) && (w < A || (w === A && C++ < v)) && x.push(n[p]);
      }
      return x;
    }
    function Wt(e, t, n) {
      ...
      return t.map(function (t) {
        ...
        for (var h = void 0, f = a.length - 1; f >= 0; f--) h = we.create(a[f], h);
        return h || (h = we.create(p.create(t, t))), h;
      });
    }
    function Bt(e, t) {
      var n = [];
            ...
            var o = r.valueNode.value,
              s = (function (e, t) {
                var n = (function (e) {
                  ...
                  return e.substring(2).split(/\//).map(Ht);
                })(t);
                if (!n) return null;
    ...
    function Kt(e, t) {
      return p.create(e.positionAt(t.offset + 1), e.positionAt(t.offset + t.length - 1));
    }
    function Ht(e) {
    ...
    function Yt(e) {
      var t = e.promiseConstructor || Promise,
        n = new St(e.schemaRequestService, e.workspaceContext, t);
      n.setSchemaContributions(Rt);
      var r = new ft(n, e.contributions, t, e.clientCapabilities),
        i = new dt(n, e.contributions, t),
        o = new It(n),
        s = new Nt(n, t);
      return {
        ...
        format: function (e, t, n) {
          ...
          return (function (e, t, n) {
            ...
            return k.replace(
              p.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length)),
              t.content,
            );
          });
        },
    ...
    var Qt = (function () {
        function e(e, t) {
          (this._ctx = e),
            ...
            (this._languageService = Yt({
              workspaceContext: {
                resolveRelativePath: function (e, t) {
                  return (function (e, t) {
                    if (
                      (function (e) {
                        return e.charCodeAt(0) === Xt;
                      })(t)
                    ) {
                      var n = gt.a.parse(e),
                        r = t.split('/');
                      return n.with({ path: en(r) }).toString();
                    }
                    return (function (e) {
                      for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                      for (
                        var r = gt.a.parse(e), i = r.path.split('/'), o = 0, s = t;
                        o < s.length;
                        o++
                      ) {
                        var a = s[o];
                      ...
                      return r.with({ path: en(i) }).toString();
                    })(e, t);
                  })(t.substr(0, t.lastIndexOf('/') + 1), e);
                },
              },
              schemaRequestService: t.enableSchemaRequest && zt,
            })),
        ...
        return (
          ...
          (e.prototype._getTextDocument = function (e) {
            for (var t = 0, n = this._ctx.getMirrorModels(); t < n.length; t++) {
              var r = n[t];
              if (r.uri.toString() === e)
                return Ie.create(e, this._languageId, r.version, r.getValue());
            }
            return null;
          }),
          e
    ...
    function en(e) {
      for (var t = [], n = 0, r = e; n < r.length; n++) {
        var i = r[n];
        0 === i.length ||
          (1 === i.length && i.charCodeAt(0) === Zt) ||
          (2 === i.length && i.charCodeAt(0) === Zt && i.charCodeAt(1) === Zt
            ? t.pop()
            : t.push(i));
      }
